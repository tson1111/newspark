...
public  class WritableFactory$ implements scala.Serializable {
  ...
  public   WritableFactory$ ()  { throw new RuntimeException(); }
   <T extends java.lang.Object, W extends org.apache.hadoop.io.Writable> org.apache.spark.WritableFactory<T> simpleWritableFactory (scala.Function1<T, W> convert, scala.reflect.ClassTag<T> evidence$22, scala.reflect.ClassTag<W> evidence$23)  { throw new RuntimeException(); }
  ...
  public <T extends org.apache.hadoop.io.Writable> org.apache.spark.WritableFactory<T> writableWritableFactory (scala.reflect.ClassTag<T> evidence$24)  { throw new RuntimeException(); }
}
