 ...
 */
   ...
   * @param testing (undocumented)
   * @param loggedEvents (undocumented)
   */
  static public  void initEventLog (java.io.OutputStream logStream, boolean testing, scala.collection.mutable.ArrayBuffer<org.json4s.JsonAST.JValue> loggedEvents)  { throw new RuntimeException(); }
  /**
  ...
  private  boolean shouldLogBlockUpdates ()  { throw new RuntimeException(); }
