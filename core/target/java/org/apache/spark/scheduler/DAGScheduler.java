 ...
 */
   ...
   * @return (undocumented)
   */
  private  long timeIntervalNumTasksCheck ()  { throw new RuntimeException(); }
  /**
   * Max number of max concurrent tasks check failures allowed for a job before fail the job
   * submission.
   * @return (undocumented)
   */
  private  int maxFailureNumTasksCheck ()  { throw new RuntimeException(); }
   ...
   * @param numTasksInStage (undocumented)
   */
  private  void checkBarrierStageWithRDDChainPattern (org.apache.spark.rdd.RDD<?> rdd, int numTasksInStage)  { throw new RuntimeException(); }
  /**
   ...
   * @param rdd (undocumented)
   */
  private  void checkBarrierStageWithDynamicAllocation (org.apache.spark.rdd.RDD<?> rdd)  { throw new RuntimeException(); }
  /**
   ...
   * @param rdd (undocumented)
   */
  private  void checkBarrierStageWithNumSlots (org.apache.spark.rdd.RDD<?> rdd)  { throw new RuntimeException(); }
  /**
  ...
  private  scala.collection.mutable.ArrayStack<org.apache.spark.ShuffleDependency<?, ?, ?>> getMissingAncestorShuffleDependencies (org.apache.spark.rdd.RDD<?> rdd)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  boolean traverseParentRDDsWithinStage (org.apache.spark.rdd.RDD<?> rdd, scala.Function1<org.apache.spark.rdd.RDD<?>, java.lang.Object> predicate)  { throw new RuntimeException(); }
  ...
  private  void postTaskEnd (org.apache.spark.scheduler.CompletionEvent event)  { throw new RuntimeException(); }
  /**
  ...
  private  void handleResubmittedFailure (org.apache.spark.scheduler.Task<?> task, org.apache.spark.scheduler.Stage stage)  { throw new RuntimeException(); }
  ...
  private  void removeExecutorAndUnregisterOutputs (java.lang.String execId, boolean fileLost, scala.Option<java.lang.String> hostToUnregisterOutputs, scala.Option<java.lang.Object> maybeEpoch)  { throw new RuntimeException(); }
  /**
   ...
   * @param willRetry (undocumented)
   */
  private  void markStageAsFinished (org.apache.spark.scheduler.Stage stage, scala.Option<java.lang.String> errorMessage, boolean willRetry)  { throw new RuntimeException(); }
  /**
