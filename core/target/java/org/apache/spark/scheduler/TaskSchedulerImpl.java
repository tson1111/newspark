 ...
 */
  ...
  private  long barrierSyncTimeout ()  { throw new RuntimeException(); }
    org.apache.spark.rpc.RpcEndpoint barrierCoordinator ()  { throw new RuntimeException(); }
  private  void maybeInitBarrierCoordinator ()  { throw new RuntimeException(); }
   ...
   */
    void markPartitionCompletedInAllTaskSets (int stageId, int partitionId, org.apache.spark.scheduler.TaskInfo taskInfo)  { throw new RuntimeException(); }
}
