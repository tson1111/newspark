 ...
 */
  ...
  private  java.util.concurrent.CopyOnWriteArrayList<org.apache.spark.scheduler.AsyncEventQueue> queues ()  { throw new RuntimeException(); }
  ...
  private  void postToQueues (org.apache.spark.scheduler.SparkListenerEvent event)  { throw new RuntimeException(); }
  /**
