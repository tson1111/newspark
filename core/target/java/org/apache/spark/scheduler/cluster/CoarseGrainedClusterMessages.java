...
public  class CoarseGrainedClusterMessages {
  ...
  static public  class SparkAppConfig implements org.apache.spark.scheduler.cluster.CoarseGrainedClusterMessage, scala.Product, scala.Serializable {
    ...
    // not preceding
    public   SparkAppConfig (scala.collection.Seq<scala.Tuple2<java.lang.String, java.lang.String>> sparkProperties, scala.Option<byte[]> ioEncryptionKey, scala.Option<byte[]> hadoopDelegationCreds)  { throw new RuntimeException(); }
  }
  static public  class SparkAppConfig$ extends scala.runtime.AbstractFunction3<scala.collection.Seq<scala.Tuple2<java.lang.String, java.lang.String>>, scala.Option<byte[]>, scala.Option<byte[]>, org.apache.spark.scheduler.cluster.CoarseGrainedClusterMessages.SparkAppConfig> implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
