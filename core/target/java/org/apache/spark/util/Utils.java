...
public  class Utils {
  ...
  static private  org.apache.spark.util.SparkUncaughtExceptionHandler sparkUncaughtExceptionHandler ()  { throw new RuntimeException(); }
  static private  java.lang.String cachedLocalDir ()  { throw new RuntimeException(); }
  /**
  ...
  static   int maxNumToStringFields ()  { throw new RuntimeException(); }
  ...
  static public  void copyFileStreamNIO (java.nio.channels.FileChannel input, java.nio.channels.FileChannel output, long startPosition, long bytesToCopy)  { throw new RuntimeException(); }
  /**
  ...
  static private  scala.util.matching.Regex SPARK_CORE_CLASS_REGEX ()  { throw new RuntimeException(); }
  static private  scala.util.matching.Regex SPARK_SQL_CLASS_REGEX ()  { throw new RuntimeException(); }
  ...
  static private  org.apache.spark.status.api.v1.ThreadStackTrace threadInfoToThreadStackTrace (java.lang.management.ThreadInfo threadInfo)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  scala.collection.Seq<scala.Tuple2<java.lang.String, java.lang.String>> redact (scala.Option<scala.util.matching.Regex> regex, scala.collection.Seq<scala.Tuple2<java.lang.String, java.lang.String>> kvs)  { throw new RuntimeException(); }
  /**
   ...
   * @param fullyQualifiedName (undocumented)
   * @return (undocumented)
   */
  static private  java.lang.String stripPackages (java.lang.String fullyQualifiedName)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  java.lang.String stripDollars (java.lang.String s)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  scala.util.matching.Regex fullWidthRegex ()  { throw new RuntimeException(); }
  /**
