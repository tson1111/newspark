...
public  class JsonProtocol$ {
  ...
  private  scala.collection.immutable.Set<java.lang.String> accumulableBlacklist ()  { throw new RuntimeException(); }
  public  org.json4s.JsonAST.JArray accumulablesToJson (scala.collection.Traversable<org.apache.spark.scheduler.AccumulableInfo> accumulables)  { throw new RuntimeException(); }
  ...
  private  scala.Option<org.json4s.JsonAST.JValue> jsonOption (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
  private  org.json4s.JsonAST.JObject emptyJson ()  { throw new RuntimeException(); }
}
