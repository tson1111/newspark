...
public  class Utils$ implements org.apache.spark.internal.Logging {
  ...
  private  org.apache.spark.util.SparkUncaughtExceptionHandler sparkUncaughtExceptionHandler ()  { throw new RuntimeException(); }
  private  java.lang.String cachedLocalDir ()  { throw new RuntimeException(); }
  /**
  ...
  public  int DEFAULT_MAX_TO_STRING_FIELDS ()  { throw new RuntimeException(); }
    int maxNumToStringFields ()  { throw new RuntimeException(); }
  ...
  public  void copyFileStreamNIO (java.nio.channels.FileChannel input, java.nio.channels.FileChannel output, long startPosition, long bytesToCopy)  { throw new RuntimeException(); }
  /**
  ...
  private  scala.util.matching.Regex SPARK_CORE_CLASS_REGEX ()  { throw new RuntimeException(); }
  private  scala.util.matching.Regex SPARK_SQL_CLASS_REGEX ()  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.status.api.v1.ThreadStackTrace threadInfoToThreadStackTrace (java.lang.management.ThreadInfo threadInfo)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.Seq<scala.Tuple2<java.lang.String, java.lang.String>> redact (scala.Option<scala.util.matching.Regex> regex, scala.collection.Seq<scala.Tuple2<java.lang.String, java.lang.String>> kvs)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  java.lang.String stripPackages (java.lang.String fullyQualifiedName)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  java.lang.String stripDollars (java.lang.String s)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  scala.util.matching.Regex fullWidthRegex ()  { throw new RuntimeException(); }
  /**
