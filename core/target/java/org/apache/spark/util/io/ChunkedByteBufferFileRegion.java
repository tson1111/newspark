 ...
 */
  ...
  private  long _transferred ()  { throw new RuntimeException(); }
  private  org.apache.spark.util.io.ChunkedByteBuffer chunkedByteBuffer ()  { throw new RuntimeException(); }
  private  java.nio.ByteBuffer[] chunks ()  { throw new RuntimeException(); }
  public  long count ()  { throw new RuntimeException(); }
  private  int currentChunkIdx ()  { throw new RuntimeException(); }
  protected  void deallocate ()  { throw new RuntimeException(); }
  private  int ioChunkSize ()  { throw new RuntimeException(); }
  public  long position ()  { throw new RuntimeException(); }
  private  long size ()  { throw new RuntimeException(); }
