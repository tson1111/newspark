...
public  class JsonProtocol {
  ...
  static private  class SPARK_LISTENER_EVENT_FORMATTED_CLASS_NAMES$ {
    ...
    public  java.lang.String blockUpdate ()  { throw new RuntimeException(); }
  }
  ...
  static private  scala.collection.immutable.Set<java.lang.String> accumulableBlacklist ()  { throw new RuntimeException(); }
  static public  org.json4s.JsonAST.JArray accumulablesToJson (scala.collection.Traversable<org.apache.spark.scheduler.AccumulableInfo> accumulables)  { throw new RuntimeException(); }
  ...
  static private  scala.Option<org.json4s.JsonAST.JValue> jsonOption (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }
  static private  org.json4s.JsonAST.JObject emptyJson ()  { throw new RuntimeException(); }
}
