...
public  class SparkContext implements org.apache.spark.internal.Logging {
  ...
  static private <T extends org.apache.hadoop.io.Writable> org.apache.hadoop.io.ArrayWritable arrayToArrayWritable (scala.collection.Traversable<T> arr, scala.reflect.ClassTag<T> evidence$19)  { throw new RuntimeException(); }
  /**
  ...
  private  org.apache.spark.scheduler.LiveListenerBus _listenerBus ()  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.status.AppStatusStore _statusStore ()  { throw new RuntimeException(); }
