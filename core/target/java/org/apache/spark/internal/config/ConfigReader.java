 ...
 */
  ...
  /**
   * Gets the value of a config from the given <code>ConfigProvider</code>. If no value is found for this
   * config, and the <code>ConfigEntry</code> defines this config has default value, return the default value.
   * @param conf (undocumented)
   * @param key (undocumented)
   * @return (undocumented)
   */
  private  scala.Option<java.lang.String> getOrDefault (org.apache.spark.internal.config.ConfigProvider conf, java.lang.String key)  { throw new RuntimeException(); }
}
