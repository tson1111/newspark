 ...
 */
  ...
  private  org.apache.hadoop.mapred.JobConf getConf ()  { throw new RuntimeException(); }
  private  org.apache.hadoop.mapred.OutputFormat<K, V> getOutputFormat ()  { throw new RuntimeException(); }
  ...
  private  java.lang.Class<? extends org.apache.hadoop.mapred.OutputFormat<K, V>> outputFormat ()  { throw new RuntimeException(); }
  public  void write (scala.Tuple2<K, V> pair)  { throw new RuntimeException(); }
  private  org.apache.hadoop.mapred.RecordWriter<K, V> writer ()  { throw new RuntimeException(); }
}
