...
public  class SparkEnv$ implements org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.SparkEnv create (org.apache.spark.SparkConf conf, java.lang.String executorId, java.lang.String bindAddress, java.lang.String advertiseAddress, scala.Option<java.lang.Object> port, boolean isLocal, int numUsableCores, scala.Option<byte[]> ioEncryptionKey, org.apache.spark.scheduler.LiveListenerBus listenerBus, scala.Option<org.apache.spark.scheduler.OutputCommitCoordinator> mockOutputCommitCoordinator)  { throw new RuntimeException(); }
  /**
