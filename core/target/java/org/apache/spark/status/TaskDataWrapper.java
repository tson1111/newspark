 ...
 */
   ...
   * @return (undocumented)
   */
  private  java.lang.String accumulators ()  { throw new RuntimeException(); }
  public  int attempt ()  { throw new RuntimeException(); }
  private  long completionTime ()  { throw new RuntimeException(); }
  public  long diskBytesSpilled ()  { throw new RuntimeException(); }
  public  long duration ()  { throw new RuntimeException(); }
  private  java.lang.String error ()  { throw new RuntimeException(); }
  ...
  private  long shuffleTotalBlocks ()  { throw new RuntimeException(); }
  private  long shuffleTotalReads ()  { throw new RuntimeException(); }
  public  long shuffleWriteTime ()  { throw new RuntimeException(); }
  public  boolean speculative ()  { throw new RuntimeException(); }
  private  int[] stage ()  { throw new RuntimeException(); }
