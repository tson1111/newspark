...
public  class RDDPartitionSeq implements scala.collection.Seq<org.apache.spark.status.api.v1.RDDPartitionInfo> {
  ...
  private  org.apache.spark.status.LiveRDDPartition _head ()  { throw new RuntimeException(); }
  private  org.apache.spark.status.LiveRDDPartition _tail ()  { throw new RuntimeException(); }
