...
public  class LiveJob extends org.apache.spark.status.LiveEntity {
  // not preceding
  public   LiveJob (int jobId, java.lang.String name, scala.Option<java.util.Date> submissionTime, scala.collection.Seq<java.lang.Object> stageIds, scala.Option<java.lang.String> jobGroup, int numTasks)  { throw new RuntimeException(); }
