...
public  class SparkConf implements scala.Cloneable, org.apache.spark.internal.Logging, scala.Serializable {
   ...
   * <p>
   * TODO: consolidate it with <code>ConfigBuilder.withAlternative</code>.
   * @return (undocumented)
   */
   ...
   * @return (undocumented)
   */
  private <T extends java.lang.Object> T catchIllegalValue (java.lang.String key, scala.Function0<T> getValue)  { throw new RuntimeException(); }
  /**
