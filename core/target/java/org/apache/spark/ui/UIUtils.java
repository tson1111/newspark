...
public  class UIUtils {
  ...
  static private  scala.util.matching.Regex NEWLINE_AND_SINGLE_QUOTE_REGEX ()  { throw new RuntimeException(); }
   ...
   * @param requestParameter (undocumented)
   * @return (undocumented)
   */
  static public  java.lang.String stripXSS (java.lang.String requestParameter)  { throw new RuntimeException(); }
