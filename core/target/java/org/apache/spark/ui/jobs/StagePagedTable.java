...
/** Page showing list of all ongoing and recently finished stages */
  ...
  private  scala.collection.Seq<scala.xml.Node> failureReasonHtml (org.apache.spark.status.api.v1.StageData s)  { throw new RuntimeException(); }
  ...
  private  scala.collection.Seq<scala.xml.Node> makeDescription (org.apache.spark.status.api.v1.StageData s, scala.Option<java.lang.String> descriptionOption)  { throw new RuntimeException(); }
