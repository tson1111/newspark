 ...
 */
  ...
  public  class TaskRunner implements java.lang.Runnable {
     ...
     * @param taskStartTime (undocumented)
     * @return (undocumented)
     */
    private  scala.Tuple2<scala.collection.Seq<org.apache.spark.util.AccumulatorV2<?, ?>>, scala.collection.Seq<org.apache.spark.scheduler.AccumulableInfo>> collectAccumulatorsAndResetStatusOnFailure (long taskStartTime)  { throw new RuntimeException(); }
  ...
  private  scala.collection.Seq<org.apache.spark.ExecutorPlugin> executorPlugins ()  { throw new RuntimeException(); }
