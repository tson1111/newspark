...
public  class WritableConverter$ implements scala.Serializable {
  ...
  public   WritableConverter$ ()  { throw new RuntimeException(); }
   <T extends java.lang.Object, W extends org.apache.hadoop.io.Writable> org.apache.spark.WritableConverter<T> simpleWritableConverter (scala.Function1<W, T> convert, scala.reflect.ClassTag<W> evidence$20)  { throw new RuntimeException(); }
  ...
  public <T extends org.apache.hadoop.io.Writable> scala.Function0<org.apache.spark.WritableConverter<T>> writableWritableConverterFn (scala.reflect.ClassTag<T> evidence$21)  { throw new RuntimeException(); }
