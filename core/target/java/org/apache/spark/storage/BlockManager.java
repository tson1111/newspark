 ...
 */
  ...
  static private  class ShuffleMetricsSource implements org.apache.spark.metrics.source.Source {
    // not preceding
    public   ShuffleMetricsSource (java.lang.String sourceName, com.codahale.metrics.MetricSet metricSet)  { throw new RuntimeException(); }
  ...
  static public  class RemoteBlockDownloadFileManager implements org.apache.spark.network.shuffle.DownloadFileManager, org.apache.spark.internal.Logging {
    private  class ReferenceWithCleanup extends java.lang.ref.WeakReference<org.apache.spark.network.shuffle.DownloadFile> {
      public   ReferenceWithCleanup (org.apache.spark.network.shuffle.DownloadFile file, java.lang.ref.ReferenceQueue<org.apache.spark.network.shuffle.DownloadFile> referenceQueue)  { throw new RuntimeException(); }
      public  void cleanUp ()  { throw new RuntimeException(); }
      public  java.lang.String filePath ()  { throw new RuntimeException(); }
    }
    private  int POLL_TIMEOUT ()  { throw new RuntimeException(); }
    ...
    private  java.util.Set<org.apache.spark.storage.BlockManager.RemoteBlockDownloadFileManager.ReferenceWithCleanup> referenceBuffer ()  { throw new RuntimeException(); }
    private  java.lang.ref.ReferenceQueue<org.apache.spark.network.shuffle.DownloadFile> referenceQueue ()  { throw new RuntimeException(); }
   ...
   */
  static private  class EncryptedDownloadFile implements org.apache.spark.network.shuffle.DownloadFile {
    private  class EncryptedDownloadWritableChannel implements org.apache.spark.network.shuffle.DownloadFileWritableChannel {
      public   EncryptedDownloadWritableChannel ()  { throw new RuntimeException(); }
      public  void close ()  { throw new RuntimeException(); }
      public  org.apache.spark.network.buffer.ManagedBuffer closeAndRead ()  { throw new RuntimeException(); }
      private  org.apache.spark.storage.CountingWritableChannel countingOutput ()  { throw new RuntimeException(); }
      public  boolean isOpen ()  { throw new RuntimeException(); }
      public  int write (java.nio.ByteBuffer src)  { throw new RuntimeException(); }
    }
    public   EncryptedDownloadFile (java.io.File file, byte[] key)  { throw new RuntimeException(); }
    public  boolean delete ()  { throw new RuntimeException(); }
    private  org.apache.spark.SparkEnv env ()  { throw new RuntimeException(); }
    public  org.apache.spark.network.shuffle.DownloadFileWritableChannel openForWriting ()  { throw new RuntimeException(); }
  ...
  private  boolean remoteReadNioBufferConversion ()  { throw new RuntimeException(); }
  ...
  private  long maxOnHeapMemory ()  { throw new RuntimeException(); }
  private  long maxOffHeapMemory ()  { throw new RuntimeException(); }
  ...
  private  long maxRemoteBlockToMem ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  scala.collection.Seq<org.apache.spark.storage.BlockManagerId> sortLocations (scala.collection.Seq<org.apache.spark.storage.BlockManagerId> locations)  { throw new RuntimeException(); }
  /**
   ...
   * The param <code>taskAttemptId</code> should be passed in case we can't get the correct TID from
   ...
   */
  public  void releaseLock (org.apache.spark.storage.BlockId blockId, scala.Option<java.lang.Object> taskAttemptId)  { throw new RuntimeException(); }
  /**
  ...
  public  void releaseLockAndDispose (org.apache.spark.storage.BlockId blockId, org.apache.spark.storage.BlockData data, scala.Option<java.lang.Object> taskAttemptId)  { throw new RuntimeException(); }
  public  void stop ()  { throw new RuntimeException(); }
}
