 ...
 */
  ...
  private  scala.Option<org.apache.spark.storage.BlockManagerMessages.BlockLocationsAndStatus> getLocationsAndStatus (org.apache.spark.storage.BlockId blockId)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.storage.BlockManagerId register (org.apache.spark.storage.BlockManagerId idWithoutTopologyInfo, long maxOnHeapMemSize, long maxOffHeapMemSize, org.apache.spark.rpc.RpcEndpointRef slaveEndpoint)  { throw new RuntimeException(); }
