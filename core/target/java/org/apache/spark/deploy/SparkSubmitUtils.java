...
public  class SparkSubmitUtils {
   ...
   * @param mdId (undocumented)
   * @param ivySettings (undocumented)
   * @param ivyConfName (undocumented)
   */
  static private  void clearIvyResolutionFiles (org.apache.ivy.core.module.id.ModuleRevisionId mdId, org.apache.ivy.core.settings.IvySettings ivySettings, java.lang.String ivyConfName)  { throw new RuntimeException(); }
  /**
