...
public  class HistoryServerDiskManager implements org.apache.spark.internal.Logging {
    ...
    private  long leased ()  { throw new RuntimeException(); }
  ...
  private  scala.collection.mutable.HashMap<scala.Tuple2<java.lang.String, scala.Option<java.lang.String>>, java.lang.Object> active ()  { throw new RuntimeException(); }
  private  java.io.File appStoreDir ()  { throw new RuntimeException(); }
  private  java.io.File appStorePath (java.lang.String appId, scala.Option<java.lang.String> attemptId)  { throw new RuntimeException(); }
  /**
  ...
  private  java.util.concurrent.atomic.AtomicLong committedUsage ()  { throw new RuntimeException(); }
  private  java.util.concurrent.atomic.AtomicLong currentUsage ()  { throw new RuntimeException(); }
  private  void deleteStore (java.io.File path)  { throw new RuntimeException(); }
  ...
  private  void makeRoom (long size)  { throw new RuntimeException(); }
  private  long maxUsage ()  { throw new RuntimeException(); }
  /**
  ...
  private  java.io.File tmpStoreDir ()  { throw new RuntimeException(); }
  private  void updateAccessTime (java.lang.String appId, scala.Option<java.lang.String> attemptId)  { throw new RuntimeException(); }
  private  void updateUsage (long delta, boolean committed)  { throw new RuntimeException(); }
}
