package org.apache.spark.deploy.worker;
  ...
  static private  scala.util.matching.Regex SSL_NODE_LOCAL_CONFIG_PATTERN ()  { throw new RuntimeException(); }
  ...
  private  boolean CLEANUP_NON_SHUFFLE_FILES_ENABLED ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  boolean preferConfiguredMasterAddress ()  { throw new RuntimeException(); }
  /**
   * The master address to connect in case of failure. When the connection is broken, worker will
   * use this address to connect. This is usually just one of <code>masterRpcAddresses</code>. However, when
   * a master is restarted or takes over leadership, it will be an address sent from master, which
   * may not be in <code>masterRpcAddresses</code>.
   * @return (undocumented)
   */
  private  scala.Option<org.apache.spark.rpc.RpcAddress> masterAddressToConnect ()  { throw new RuntimeException(); }
   ...
   *                      failure
   */
  private  void changeMaster (org.apache.spark.rpc.RpcEndpointRef masterRef, java.lang.String uiUrl, org.apache.spark.rpc.RpcAddress masterAddress)  { throw new RuntimeException(); }
  ...
  private  void startExternalShuffleService ()  { throw new RuntimeException(); }
