...
public abstract class Partitioner implements scala.Serializable {
   ...
   * @return (undocumented)
   */
  static private  boolean isEligiblePartitioner (org.apache.spark.rdd.RDD<?> hasMaxPartitioner, scala.collection.Seq<org.apache.spark.rdd.RDD<?>> rdds)  { throw new RuntimeException(); }
