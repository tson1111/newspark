...
public  class DStream$ implements scala.Serializable {
  ...
  private  scala.util.matching.Regex SPARK_STREAMING_TESTCLASS_REGEX ()  { throw new RuntimeException(); }
  private  scala.util.matching.Regex SPARK_EXAMPLES_CLASS_REGEX ()  { throw new RuntimeException(); }
  private  scala.util.matching.Regex SCALA_CLASS_REGEX ()  { throw new RuntimeException(); }
