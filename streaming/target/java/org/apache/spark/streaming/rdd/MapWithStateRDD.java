 ...
 */
  ...
  private  org.apache.spark.rdd.RDD<org.apache.spark.streaming.rdd.MapWithStateRDDRecord<K, S, E>> prevStateRDD ()  { throw new RuntimeException(); }
  private  org.apache.spark.rdd.RDD<scala.Tuple2<K, V>> partitionedDataRDD ()  { throw new RuntimeException(); }
  // not preceding
  ...
  private  boolean doFullScan ()  { throw new RuntimeException(); }
