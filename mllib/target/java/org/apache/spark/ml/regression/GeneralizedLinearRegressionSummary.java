...
public  class GeneralizedLinearRegressionSummary implements scala.Serializable {
  ...
  private  org.apache.spark.sql.Column label ()  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.Column offset ()  { throw new RuntimeException(); }
    org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> pearsonResiduals ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.Column prediction ()  { throw new RuntimeException(); }
  /**
  ...
  private  org.apache.spark.sql.Column weight ()  { throw new RuntimeException(); }
