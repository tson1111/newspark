 ...
 */
  ...
  static public  class Metadata implements scala.Product, scala.Serializable {
    ...
    private  scala.collection.Seq<scala.Tuple2<java.lang.String, org.json4s.JsonAST.JValue>> getValueFromParams (org.json4s.JsonAST.JValue params)  { throw new RuntimeException(); }
    /**
    ...
    private  void setParams (org.apache.spark.ml.param.Params instance, scala.Option<scala.collection.immutable.List<java.lang.String>> skipParams, boolean isDefault)  { throw new RuntimeException(); }
  }
