...
public  class FPGrowthModel extends org.apache.spark.ml.Model<org.apache.spark.ml.fpm.FPGrowthModel> implements org.apache.spark.ml.fpm.FPGrowthParams, org.apache.spark.ml.util.MLWritable {
  ...
  private  scala.collection.Map<java.lang.Object, java.lang.Object> itemSupport ()  { throw new RuntimeException(); }
  private  long numTrainingRecords ()  { throw new RuntimeException(); }
  // not preceding
   ...
   * @return (undocumented)
   */
  private  double _cachedMinConf ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> _cachedRules ()  { throw new RuntimeException(); }
  /**
