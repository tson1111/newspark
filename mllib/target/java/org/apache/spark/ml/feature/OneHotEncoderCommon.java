...
public  class OneHotEncoderCommon {
  static private  scala.Option<java.lang.String[]> genOutputAttrNames (org.apache.spark.sql.types.StructField inputCol)  { throw new RuntimeException(); }
  /** Creates an `AttributeGroup` filled by the `BinaryAttribute` named as required. */
  static private  org.apache.spark.ml.attribute.AttributeGroup genOutputAttrGroup (scala.Option<java.lang.String[]> outputAttrNames, java.lang.String outputColName)  { throw new RuntimeException(); }
  /**
