 ...
 * The last category is not included by default (configurable via <code>OneHotEncoder!.dropLast</code>
 ...
 * @deprecated <code>OneHotEncoderEstimator</code> will be renamed <code>OneHotEncoder</code> and this <code>OneHotEncoder</code>
 * will be removed in 3.0.0.
 *
 * @deprecated `OneHotEncoderEstimator` will be renamed `OneHotEncoder` and this `OneHotEncoder` will be removed in 3.0.0. Since 2.3.0. 
*/
public  class OneHotEncoder extends org.apache.spark.ml.Transformer implements org.apache.spark.ml.param.shared.HasInputCol, org.apache.spark.ml.param.shared.HasOutputCol, org.apache.spark.ml.util.DefaultParamsWritable {
  ...
  /** @group getParam */
  public  boolean getDropLast ()  { throw new RuntimeException(); }
  /** @group setParam */
