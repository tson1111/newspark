...
public final class QuantileDiscretizer extends org.apache.spark.ml.Estimator<org.apache.spark.ml.feature.Bucketizer> implements org.apache.spark.ml.feature.QuantileDiscretizerBase, org.apache.spark.ml.util.DefaultParamsWritable, org.apache.spark.ml.param.shared.HasInputCols, org.apache.spark.ml.param.shared.HasOutputCols {
  ...
  static public  org.apache.spark.ml.param.IntArrayParam numBucketsArray ()  { throw new RuntimeException(); }
  static public  int[] getNumBucketsArray ()  { throw new RuntimeException(); }
  ...
  private  double[] getDistinctSplits (double[] splits)  { throw new RuntimeException(); }
