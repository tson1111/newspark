...
public  class SharedParamsCodeGen {
  ...
  static private  class ParamDesc<T extends java.lang.Object> implements scala.Product, scala.Serializable {
    ...
    public  boolean finalFields ()  { throw new RuntimeException(); }
    public  boolean isExpertParam ()  { throw new RuntimeException(); }
    // not preceding
    public   ParamDesc (java.lang.String name, java.lang.String doc, scala.Option<java.lang.String> defaultValueStr, java.lang.String isValid, boolean finalMethods, boolean finalFields, boolean isExpertParam, scala.reflect.ClassTag<T> evidence$1)  { throw new RuntimeException(); }
