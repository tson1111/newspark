...
public  class AvroDeserializer {
  ...
  private  org.apache.spark.sql.types.Decimal createDecimal (java.math.BigDecimal decimal, int precision, int scale)  { throw new RuntimeException(); }
  ...
  private  scala.Function2<org.apache.spark.sql.avro.AvroDeserializer.CatalystDataUpdater, org.apache.avro.generic.GenericRecord, scala.runtime.BoxedUnit> getRecordWriter (org.apache.avro.Schema avroType, org.apache.spark.sql.types.StructType sqlType, scala.collection.immutable.List<java.lang.String> path)  { throw new RuntimeException(); }
  /**
   * Creates a writer to write avro values to Catalyst values at the given ordinal with the given
   * updater.
   * @param avroType (undocumented)
   * @param catalystType (undocumented)
   * @param path (undocumented)
   * @return (undocumented)
   */
  private  scala.Function3<org.apache.spark.sql.avro.AvroDeserializer.CatalystDataUpdater, java.lang.Object, java.lang.Object, scala.runtime.BoxedUnit> newWriter (org.apache.avro.Schema avroType, org.apache.spark.sql.types.DataType catalystType, scala.collection.immutable.List<java.lang.String> path)  { throw new RuntimeException(); }
}
