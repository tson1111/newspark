 ...
 */
  ...
  private  org.apache.spark.sql.kafka010.KafkaSourceRDDOffsetRange resolveRange (org.apache.spark.sql.kafka010.KafkaDataConsumer consumer, org.apache.spark.sql.kafka010.KafkaSourceRDDOffsetRange range)  { throw new RuntimeException(); }
}
