 ...
 */
  class KafkaSourceProvider implements org.apache.spark.sql.sources.DataSourceRegister, org.apache.spark.sql.sources.StreamSourceProvider, org.apache.spark.sql.sources.StreamSinkProvider, org.apache.spark.sql.sources.RelationProvider, org.apache.spark.sql.sources.CreatableRelationProvider, org.apache.spark.sql.sources.v2.StreamWriteSupport, org.apache.spark.sql.sources.v2.ContinuousReadSupport, org.apache.spark.sql.sources.v2.MicroBatchReadSupport, org.apache.spark.internal.Logging {
  /** Class to conveniently update Kafka config params, while logging the changes */
  static private  class ConfigUpdater implements scala.Product, scala.Serializable {
  ...
  static private  class ConfigUpdater$ extends scala.runtime.AbstractFunction2<java.lang.String, scala.collection.immutable.Map<java.lang.String, java.lang.String>, org.apache.spark.sql.kafka010.KafkaSourceProvider.ConfigUpdater> implements scala.Serializable {
    /**
  ...
  static private  java.lang.String MIN_PARTITIONS_OPTION_KEY ()  { throw new RuntimeException(); }
  ...
  static   scala.collection.immutable.Map<java.lang.String, java.lang.String> kafkaParamsForProducer (scala.collection.immutable.Map<java.lang.String, java.lang.String> parameters)  { throw new RuntimeException(); }
  ...
  /**
   * Creates a {@link org.apache.spark.sql.sources.v2.reader.streaming.MicroBatchReader} to read batches
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.kafka010.KafkaMicroBatchReader createMicroBatchReader (java.util.Optional<org.apache.spark.sql.types.StructType> schema, java.lang.String metadataPath, org.apache.spark.sql.sources.v2.DataSourceOptions options)  { throw new RuntimeException(); }
  /**
   * Creates a {@link ContinuousInputPartitionReader} to read
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.kafka010.KafkaContinuousReader createContinuousReader (java.util.Optional<org.apache.spark.sql.types.StructType> schema, java.lang.String metadataPath, org.apache.spark.sql.sources.v2.DataSourceOptions options)  { throw new RuntimeException(); }
  /**
