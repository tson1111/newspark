...
public  class BLAS$ implements scala.Serializable {
   ...
   * @param y (undocumented)
   */
  private  void axpy (double a, org.apache.spark.ml.linalg.DenseVector x, org.apache.spark.ml.linalg.DenseVector y)  { throw new RuntimeException(); }
  /**
   * y += a * x
   * @param a (undocumented)
   * @param x (undocumented)
   * @param y (undocumented)
   */
  private  void axpy (double a, org.apache.spark.ml.linalg.SparseVector x, org.apache.spark.ml.linalg.DenseVector y)  { throw new RuntimeException(); }
  /** Y += a * x */
   ...
   * @return (undocumented)
   */
  private  double dot (org.apache.spark.ml.linalg.DenseVector x, org.apache.spark.ml.linalg.DenseVector y)  { throw new RuntimeException(); }
  /**
   * dot(x, y)
   * @param x (undocumented)
   * @param y (undocumented)
   * @return (undocumented)
   */
  private  double dot (org.apache.spark.ml.linalg.SparseVector x, org.apache.spark.ml.linalg.DenseVector y)  { throw new RuntimeException(); }
  /**
   * dot(x, y)
   * @param x (undocumented)
   * @param y (undocumented)
   * @return (undocumented)
   */
  private  double dot (org.apache.spark.ml.linalg.SparseVector x, org.apache.spark.ml.linalg.SparseVector y)  { throw new RuntimeException(); }
  /**
   * y = x
   * @param x (undocumented)
   * @param y (undocumented)
  ...
  private  void syr (double alpha, org.apache.spark.ml.linalg.DenseVector x, org.apache.spark.ml.linalg.DenseMatrix A)  { throw new RuntimeException(); }
  private  void syr (double alpha, org.apache.spark.ml.linalg.SparseVector x, org.apache.spark.ml.linalg.DenseMatrix A)  { throw new RuntimeException(); }
  /**
   * C := alpha * A * B + beta * C
   ...
   */
  private  void gemm (double alpha, org.apache.spark.ml.linalg.DenseMatrix A, org.apache.spark.ml.linalg.DenseMatrix B, double beta, org.apache.spark.ml.linalg.DenseMatrix C)  { throw new RuntimeException(); }
  /**
   * C := alpha * A * B + beta * C
   ...
   * @param C (undocumented)
   */
  private  void gemm (double alpha, org.apache.spark.ml.linalg.SparseMatrix A, org.apache.spark.ml.linalg.DenseMatrix B, double beta, org.apache.spark.ml.linalg.DenseMatrix C)  { throw new RuntimeException(); }
  /**
   * y := alpha * A * x + beta * y
   ...
   * @param y (undocumented)
   */
  private  void gemv (double alpha, org.apache.spark.ml.linalg.DenseMatrix A, org.apache.spark.ml.linalg.DenseVector x, double beta, org.apache.spark.ml.linalg.DenseVector y)  { throw new RuntimeException(); }
  /**
   * y := alpha * A * x + beta * y
   ...
   * @param y (undocumented)
   */
  private  void gemv (double alpha, org.apache.spark.ml.linalg.DenseMatrix A, org.apache.spark.ml.linalg.SparseVector x, double beta, org.apache.spark.ml.linalg.DenseVector y)  { throw new RuntimeException(); }
  /**
   * y := alpha * A * x + beta * y
   ...
   * @param y (undocumented)
   */
  private  void gemv (double alpha, org.apache.spark.ml.linalg.SparseMatrix A, org.apache.spark.ml.linalg.SparseVector x, double beta, org.apache.spark.ml.linalg.DenseVector y)  { throw new RuntimeException(); }
  /**
   * y := alpha * A * x + beta * y
   ...
   * @param y (undocumented)
   */
  private  void gemv (double alpha, org.apache.spark.ml.linalg.SparseMatrix A, org.apache.spark.ml.linalg.DenseVector x, double beta, org.apache.spark.ml.linalg.DenseVector y)  { throw new RuntimeException(); }
}
