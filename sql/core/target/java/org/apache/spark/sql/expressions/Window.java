...
public  class Window {
   ...
   * @return (undocumented)
   *
   * @deprecated Use the version with Long parameter types. Since 2.4.0. 
  */
  static public  org.apache.spark.sql.expressions.WindowSpec rangeBetween (org.apache.spark.sql.Column start, org.apache.spark.sql.Column end)  { throw new RuntimeException(); }
