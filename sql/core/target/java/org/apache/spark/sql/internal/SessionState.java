 ...
 */
  ...
  // not preceding
  public   SessionState (org.apache.spark.sql.internal.SharedState sharedState, org.apache.spark.sql.internal.SQLConf conf, org.apache.spark.sql.ExperimentalMethods experimentalMethods, org.apache.spark.sql.catalyst.analysis.FunctionRegistry functionRegistry, org.apache.spark.sql.UDFRegistration udfRegistration, scala.Function0<org.apache.spark.sql.catalyst.catalog.SessionCatalog> catalogBuilder, org.apache.spark.sql.catalyst.parser.ParserInterface sqlParser, scala.Function0<org.apache.spark.sql.catalyst.analysis.Analyzer> analyzerBuilder, scala.Function0<org.apache.spark.sql.catalyst.optimizer.Optimizer> optimizerBuilder, org.apache.spark.sql.execution.SparkPlanner planner, org.apache.spark.sql.streaming.StreamingQueryManager streamingQueryManager, org.apache.spark.sql.util.ExecutionListenerManager listenerManager, scala.Function0<org.apache.spark.sql.internal.SessionResourceLoader> resourceLoaderBuilder, scala.Function1<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan, org.apache.spark.sql.execution.QueryExecution> createQueryExecution, scala.Function2<org.apache.spark.sql.SparkSession, org.apache.spark.sql.internal.SessionState, org.apache.spark.sql.internal.SessionState> createClone)  { throw new RuntimeException(); }
