...
public  class PythonForeachWriter extends org.apache.spark.sql.ForeachWriter<org.apache.spark.sql.catalyst.expressions.UnsafeRow> {
  ...
  static public  class UnsafeRowBuffer implements org.apache.spark.internal.Logging {
    ...
    private  boolean allAdded ()  { throw new RuntimeException(); }
    ...
    private  org.apache.spark.sql.execution.python.HybridRowQueue queue ()  { throw new RuntimeException(); }
    private  org.apache.spark.sql.catalyst.expressions.UnsafeRow remove ()  { throw new RuntimeException(); }
    private  java.util.concurrent.locks.Condition unblockRemove ()  { throw new RuntimeException(); }
    private <T extends java.lang.Object> T withLock (scala.Function0<T> f)  { throw new RuntimeException(); }
  }
  ...
  private  org.apache.spark.TaskContext context ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.execution.python.PythonForeachWriter.UnsafeRowBuffer buffer ()  { throw new RuntimeException(); }
  private  org.apache.spark.util.NextIterator<org.apache.spark.sql.catalyst.expressions.UnsafeRow> inputRowIterator ()  { throw new RuntimeException(); }
  private  org.apache.spark.api.python.SerDeUtil.AutoBatchedPickler inputByteIterator ()  { throw new RuntimeException(); }
  private  org.apache.spark.api.python.PythonRunner pythonRunner ()  { throw new RuntimeException(); }
  private  scala.collection.Iterator<byte[]> outputIterator ()  { throw new RuntimeException(); }
