...
public  class ArrowEvalPythonExec extends org.apache.spark.sql.execution.python.EvalPythonExec implements scala.Product, scala.Serializable {
  ...
  static public  scala.collection.Seq<org.apache.spark.sql.execution.SparkPlan> children ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   ArrowEvalPythonExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.PythonUDF> udfs, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
  private  int batchSize ()  { throw new RuntimeException(); }
  private  java.lang.String sessionLocalTimeZone ()  { throw new RuntimeException(); }
  private  scala.collection.immutable.Map<java.lang.String, java.lang.String> pythonRunnerConf ()  { throw new RuntimeException(); }
