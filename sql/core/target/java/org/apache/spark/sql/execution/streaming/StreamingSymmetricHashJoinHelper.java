...
public  class StreamingSymmetricHashJoinHelper {
   ...
   * loaded. This is class is a modified version of {@link ZippedPartitionsRDD2}.
   */
  static public  class StateStoreAwareZipPartitionsRDD<A extends java.lang.Object, B extends java.lang.Object, V extends java.lang.Object> extends org.apache.spark.rdd.ZippedPartitionsRDD2<A, B, V> {
    // not preceding
    public   StateStoreAwareZipPartitionsRDD (org.apache.spark.SparkContext sc, scala.Function2<scala.collection.Iterator<A>, scala.collection.Iterator<B>, scala.collection.Iterator<V>> f, org.apache.spark.rdd.RDD<A> rdd1, org.apache.spark.rdd.RDD<B> rdd2, org.apache.spark.sql.execution.streaming.StatefulOperatorStateInfo stateInfo, scala.collection.Seq<java.lang.String> stateStoreNames, scala.Option<org.apache.spark.sql.execution.streaming.state.StateStoreCoordinatorRef> storeCoordinator, scala.reflect.ClassTag<A> evidence$1, scala.reflect.ClassTag<B> evidence$2, scala.reflect.ClassTag<V> evidence$3)  { throw new RuntimeException(); }
    /**
