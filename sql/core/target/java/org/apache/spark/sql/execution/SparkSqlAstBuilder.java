...
public  class SparkSqlAstBuilder extends org.apache.spark.sql.catalyst.parser.AstBuilder {
  ...
  private  java.lang.String extractUnquotedResourcePath (org.apache.spark.sql.catalyst.parser.SqlBaseParser.RefreshResourceContext ctx)  { throw new RuntimeException(); }
  /**
  ...
  private  void validateRowFormatFileFormat (scala.collection.Seq<org.apache.spark.sql.catalyst.parser.SqlBaseParser.RowFormatContext> rowFormatCtx, scala.collection.Seq<org.apache.spark.sql.catalyst.parser.SqlBaseParser.CreateFileFormatContext> createFileFormatCtx, org.antlr.v4.runtime.ParserRuleContext parentCtx)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Create an {@link AnalyzeTableCommand} command, or an {@link AnalyzePartitionCommand}
   * or an {@link AnalyzeColumnCommand} command.
  ...
  /**
   * Create a {@link DescribeColumnCommand} or {@link DescribeTableCommand} logical commands.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
