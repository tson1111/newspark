...
/**
 * Preprocess the {@link InsertIntoTable} plan. Throws exception if the number of columns mismatch, or
...
public  class PreprocessTableInsertion extends org.apache.spark.sql.catalyst.rules.Rule<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> implements scala.Product, scala.Serializable {
  ...
  private  org.apache.spark.sql.catalyst.plans.logical.InsertIntoTable preprocess (org.apache.spark.sql.catalyst.plans.logical.InsertIntoTable insert, java.lang.String tblName, scala.collection.Seq<java.lang.String> partColNames)  { throw new RuntimeException(); }
