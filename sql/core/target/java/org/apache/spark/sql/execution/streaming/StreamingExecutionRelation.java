...
public  class StreamingExecutionRelation extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.catalyst.analysis.MultiInstanceRelation, scala.Product, scala.Serializable {
  ...
  public  org.apache.spark.sql.execution.streaming.BaseStreamingSource source ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output ()  { throw new RuntimeException(); }
  // not preceding
  public   StreamingExecutionRelation (org.apache.spark.sql.execution.streaming.BaseStreamingSource source, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.sql.SparkSession session)  { throw new RuntimeException(); }
