...
public  class OffsetSeq implements scala.Product, scala.Serializable {
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.execution.streaming.StreamProgress toStreamProgress (scala.collection.Seq<org.apache.spark.sql.execution.streaming.BaseStreamingSource> sources)  { throw new RuntimeException(); }
