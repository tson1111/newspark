...
/**
 * Used to query the data that has been written into a {@link MemorySinkV2}.
 */
public  class MemoryPlanV2 extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   MemoryPlanV2 (org.apache.spark.sql.execution.streaming.sources.MemorySinkV2 sink, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output)  { throw new RuntimeException(); }
  private  scala.math.BigInt sizePerRow ()  { throw new RuntimeException(); }
