...
public  class CacheManager implements org.apache.spark.internal.Logging {
  ...
  private  void recacheByCondition (org.apache.spark.sql.SparkSession spark, scala.Function1<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan, java.lang.Object> condition, boolean clearCache)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  void uncacheQuery (org.apache.spark.sql.Dataset<?> query, boolean cascade, boolean blocking)  { throw new RuntimeException(); }
  /**
   * Un-cache the given plan or all the cache entries that refer to the given plan.
