...
public  class ContinuousQueuedDataReader implements java.io.Closeable {
  ...
  public  class ContinuousRow implements org.apache.spark.sql.execution.streaming.continuous.ContinuousQueuedDataReader.ContinuousRecord, scala.Product, scala.Serializable {
    ...
    // not preceding
    public   ContinuousRow (org.apache.spark.sql.catalyst.InternalRow row, org.apache.spark.sql.sources.v2.reader.streaming.PartitionOffset offset)  { throw new RuntimeException(); }
  }
  public  class ContinuousRow$ extends scala.runtime.AbstractFunction2<org.apache.spark.sql.catalyst.InternalRow, org.apache.spark.sql.sources.v2.reader.streaming.PartitionOffset, org.apache.spark.sql.execution.streaming.continuous.ContinuousQueuedDataReader.ContinuousRow> implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
   ...
   * a new row arrives to the {@link InputPartitionReader}.
   */
  public  class DataReaderThread extends java.lang.Thread implements org.apache.spark.internal.Logging {
    public   DataReaderThread ()  { throw new RuntimeException(); }
  ...
  public  class EpochMarkerGenerator implements java.lang.Runnable, org.apache.spark.internal.Logging {
    ...
    private  org.apache.spark.rpc.RpcEndpointRef epochCoordEndpoint ()  { throw new RuntimeException(); }
      java.lang.Throwable failureReason ()  { throw new RuntimeException(); }
    public  void run ()  { throw new RuntimeException(); }
  }
  public   ContinuousQueuedDataReader (org.apache.spark.sql.execution.streaming.continuous.ContinuousDataSourceRDDPartition partition, org.apache.spark.TaskContext context, int dataQueueSize, long epochPollIntervalMs)  { throw new RuntimeException(); }
  ...
  private  java.lang.String coordinatorId ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.sources.v2.reader.streaming.PartitionOffset currentOffset ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.execution.streaming.continuous.ContinuousQueuedDataReader.DataReaderThread dataReaderThread ()  { throw new RuntimeException(); }
  private  org.apache.spark.rpc.RpcEndpointRef epochCoordEndpoint ()  { throw new RuntimeException(); }
  private  java.util.concurrent.ScheduledExecutorService epochMarkerExecutor ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.execution.streaming.continuous.ContinuousQueuedDataReader.EpochMarkerGenerator epochMarkerGenerator ()  { throw new RuntimeException(); }
  /**
  ...
  private  java.util.concurrent.ArrayBlockingQueue<org.apache.spark.sql.execution.streaming.continuous.ContinuousQueuedDataReader.ContinuousRecord> queue ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.sources.v2.reader.InputPartitionReader<org.apache.spark.sql.catalyst.InternalRow> reader ()  { throw new RuntimeException(); }
  private  boolean shouldStop ()  { throw new RuntimeException(); }
}
