...
public  class MultiLineCSVDataSource$ extends org.apache.spark.sql.execution.datasources.csv.CSVDataSource {
  ...
  public  scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> readFile (org.apache.hadoop.conf.Configuration conf, org.apache.spark.sql.execution.datasources.PartitionedFile file, org.apache.spark.sql.execution.datasources.csv.UnivocityParser parser, org.apache.spark.sql.types.StructType requiredSchema, org.apache.spark.sql.types.StructType dataSchema, boolean caseSensitive, boolean columnPruning)  { throw new RuntimeException(); }
