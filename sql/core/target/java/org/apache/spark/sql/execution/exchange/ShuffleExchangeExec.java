 ...
 */
public  class ShuffleExchangeExec extends org.apache.spark.sql.execution.exchange.Exchange implements scala.Product, scala.Serializable {
  static public  org.apache.spark.sql.execution.exchange.ShuffleExchangeExec apply (org.apache.spark.sql.catalyst.plans.physical.Partitioning newPartitioning, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
  /**
   ...
   */
  static private  boolean needToCopyObjectsBeforeShuffle (org.apache.spark.Partitioner partitioner)  { throw new RuntimeException(); }
  ...
  // not preceding
  public   ShuffleExchangeExec (org.apache.spark.sql.catalyst.plans.physical.Partitioning newPartitioning, org.apache.spark.sql.execution.SparkPlan child, scala.Option<org.apache.spark.sql.execution.exchange.ExchangeCoordinator> coordinator)  { throw new RuntimeException(); }
