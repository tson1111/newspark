 ...
 */
public  class StreamProgress implements scala.collection.immutable.Map<org.apache.spark.sql.execution.streaming.BaseStreamingSource, org.apache.spark.sql.execution.streaming.Offset> {
  ...
  public  scala.collection.immutable.Map<org.apache.spark.sql.execution.streaming.BaseStreamingSource, org.apache.spark.sql.execution.streaming.Offset> baseMap ()  { throw new RuntimeException(); }
  // not preceding
  public   StreamProgress (scala.collection.immutable.Map<org.apache.spark.sql.execution.streaming.BaseStreamingSource, org.apache.spark.sql.execution.streaming.Offset> baseMap)  { throw new RuntimeException(); }
  public  org.apache.spark.sql.execution.streaming.OffsetSeq toOffsetSeq (scala.collection.Seq<org.apache.spark.sql.execution.streaming.BaseStreamingSource> source, org.apache.spark.sql.execution.streaming.OffsetSeqMetadata metadata)  { throw new RuntimeException(); }
  public  java.lang.String toString ()  { throw new RuntimeException(); }
  public  scala.Option<org.apache.spark.sql.execution.streaming.Offset> get (org.apache.spark.sql.execution.streaming.BaseStreamingSource key)  { throw new RuntimeException(); }
  public  scala.collection.Iterator<scala.Tuple2<org.apache.spark.sql.execution.streaming.BaseStreamingSource, org.apache.spark.sql.execution.streaming.Offset>> iterator ()  { throw new RuntimeException(); }
}
