...
public  class OrcFilters$ {
  ...
  public   OrcFilters$ ()  { throw new RuntimeException(); }
    scala.Option<org.apache.spark.sql.sources.Filter> buildTree (scala.collection.Seq<org.apache.spark.sql.sources.Filter> filters)  { throw new RuntimeException(); }
  private  java.lang.String quoteAttributeNameIfNeeded (java.lang.String name)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Option<org.apache.orc.storage.ql.io.sarg.SearchArgument> createFilter (org.apache.spark.sql.types.StructType schema, scala.collection.Seq<org.apache.spark.sql.sources.Filter> filters)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  boolean isSearchableType (org.apache.spark.sql.types.DataType dataType)  { throw new RuntimeException(); }
  /**
   * Get PredicateLeafType which is corresponding to the given DataType.
   * @param dataType (undocumented)
   * @return (undocumented)
   */
  private  org.apache.orc.storage.ql.io.sarg.PredicateLeaf.Type getPredicateLeafType (org.apache.spark.sql.types.DataType dataType)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  Object castLiteralValue (Object value, org.apache.spark.sql.types.DataType dataType)  { throw new RuntimeException(); }
  /**
