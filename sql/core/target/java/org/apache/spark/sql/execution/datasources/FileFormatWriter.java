...
public  class FileFormatWriter {
  ...
  static private  org.apache.spark.sql.execution.datasources.WriteTaskResult executeTask (org.apache.spark.sql.execution.datasources.WriteJobDescription description, int sparkStageId, int sparkPartitionId, int sparkAttemptNumber, org.apache.spark.internal.io.FileCommitProtocol committer, scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> iterator)  { throw new RuntimeException(); }
  /**
