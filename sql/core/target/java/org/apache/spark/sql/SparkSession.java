...
public  class SparkSession implements scala.Serializable, java.io.Closeable, org.apache.spark.internal.Logging {
  ...
  static private  void assertOnDriver ()  { throw new RuntimeException(); }
  /**
  ...
  // not preceding
  private   SparkSession (org.apache.spark.SparkContext sparkContext, scala.Option<org.apache.spark.sql.internal.SharedState> existingSharedState, scala.Option<org.apache.spark.sql.internal.SessionState> parentSessionState, org.apache.spark.sql.SparkSessionExtensions extensions)  { throw new RuntimeException(); }
  ...
  /**
   * Creates a <code>DataFrame</code> from an <code>RDD[Row]</code>.
