 ...
 */
  ...
  static private  org.apache.parquet.schema.Type clipParquetType (org.apache.parquet.schema.Type parquetType, org.apache.spark.sql.types.DataType catalystType, boolean caseSensitive)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  org.apache.parquet.schema.Type clipParquetListType (org.apache.parquet.schema.GroupType parquetList, org.apache.spark.sql.types.DataType elementType, boolean caseSensitive)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  org.apache.parquet.schema.GroupType clipParquetMapType (org.apache.parquet.schema.GroupType parquetMap, org.apache.spark.sql.types.DataType keyType, org.apache.spark.sql.types.DataType valueType, boolean caseSensitive)  { throw new RuntimeException(); }
  /**
   ...
   * @param caseSensitive (undocumented)
   */
  static private  org.apache.parquet.schema.GroupType clipParquetGroup (org.apache.parquet.schema.GroupType parquetRecord, org.apache.spark.sql.types.StructType structType, boolean caseSensitive)  { throw new RuntimeException(); }
  /**
   * Clips a Parquet {@link GroupType} which corresponds to a Catalyst {@link StructType}.
   * <p>
   ...
   * @param caseSensitive (undocumented)
   */
  static private  scala.collection.Seq<org.apache.parquet.schema.Type> clipParquetGroupFields (org.apache.parquet.schema.GroupType parquetRecord, org.apache.spark.sql.types.StructType structType, boolean caseSensitive)  { throw new RuntimeException(); }
  ...
  public  scala.Option<java.util.TimeZone> convertTz ()  { throw new RuntimeException(); }
  // not preceding
  public   ParquetReadSupport (scala.Option<java.util.TimeZone> convertTz)  { throw new RuntimeException(); }
