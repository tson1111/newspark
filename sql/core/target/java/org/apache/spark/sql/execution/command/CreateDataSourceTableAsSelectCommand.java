...
public  class CreateDataSourceTableAsSelectCommand extends org.apache.spark.sql.catalyst.plans.logical.LogicalPlan implements org.apache.spark.sql.execution.command.DataWritingCommand, scala.Product, scala.Serializable {
  ...
  private  org.apache.spark.sql.sources.BaseRelation saveDataIntoTable (org.apache.spark.sql.SparkSession session, org.apache.spark.sql.catalyst.catalog.CatalogTable table, scala.Option<java.net.URI> tableLocation, org.apache.spark.sql.execution.SparkPlan physicalPlan, org.apache.spark.sql.SaveMode mode, boolean tableExists)  { throw new RuntimeException(); }
}
