...
public  class BatchEvalPythonExec extends org.apache.spark.sql.execution.python.EvalPythonExec implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   BatchEvalPythonExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.PythonUDF> udfs, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
