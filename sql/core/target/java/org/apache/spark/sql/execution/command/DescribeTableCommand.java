 ...
 * </code></pre>
 */
public  class DescribeTableCommand extends org.apache.spark.sql.catalyst.plans.logical.LogicalPlan implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  private  void describeSchema (org.apache.spark.sql.types.StructType schema, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer, boolean header)  { throw new RuntimeException(); }
