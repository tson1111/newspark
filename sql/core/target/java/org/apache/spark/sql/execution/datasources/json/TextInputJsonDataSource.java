...
public  class TextInputJsonDataSource {
  ...
  static private  org.apache.spark.sql.Dataset<java.lang.String> createBaseDataset (org.apache.spark.sql.SparkSession sparkSession, scala.collection.Seq<org.apache.hadoop.fs.FileStatus> inputPaths, org.apache.spark.sql.catalyst.json.JSONOptions parsedOptions)  { throw new RuntimeException(); }
