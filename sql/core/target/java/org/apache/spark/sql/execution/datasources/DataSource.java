...
public  class DataSource implements org.apache.spark.internal.Logging, scala.Product, scala.Serializable {
   ...
   * @param schema
   */
  static private  void validateSchema (org.apache.spark.sql.types.StructType schema)  { throw new RuntimeException(); }
  ...
  private  scala.Function2<java.lang.String, java.lang.String, java.lang.Object> equality ()  { throw new RuntimeException(); }
  /**
   ...
   * @param fileIndex optional {@link InMemoryFileIndex} for getting partition schema and file list
   * @return A pair of the data schema (excluding partition columns) and the schema of the partition
   *         columns.
   */
  private  scala.Tuple2<org.apache.spark.sql.types.StructType, org.apache.spark.sql.types.StructType> getOrInferFileFormatSchema (org.apache.spark.sql.execution.datasources.FileFormat format, scala.Option<org.apache.spark.sql.execution.datasources.InMemoryFileIndex> fileIndex)  { throw new RuntimeException(); }
  ...
  /**
   * Creates a command node to write the given {@link LogicalPlan} out to the given {@link FileFormat}.
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.sql.execution.datasources.InsertIntoHadoopFsRelationCommand planForWritingFileFormat (org.apache.spark.sql.execution.datasources.FileFormat format, org.apache.spark.sql.SaveMode mode, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan data)  { throw new RuntimeException(); }
  /**
  ...
  /** Returns an {@link InMemoryFileIndex} that can be used to get partition schema and file list. */
  private  org.apache.spark.sql.execution.datasources.InMemoryFileIndex createInMemoryFileIndex (scala.collection.Seq<org.apache.hadoop.fs.Path> globbedPaths)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  scala.collection.Seq<org.apache.hadoop.fs.Path> checkAndGlobPathIfNecessary (boolean checkEmptyGlobPath, boolean checkFilesExist)  { throw new RuntimeException(); }
}
