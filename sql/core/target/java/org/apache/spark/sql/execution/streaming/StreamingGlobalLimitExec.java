...
public  class StreamingGlobalLimitExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, org.apache.spark.sql.execution.streaming.StateStoreWriter, scala.Product, scala.Serializable {
  ...
  static public  boolean shouldRunAnotherBatch (org.apache.spark.sql.execution.streaming.OffsetSeqMetadata newMetadata)  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.catalyst.expressions.UnsafeRow getValueRow (long value)  { throw new RuntimeException(); }
}
