...
public  class ShuffleExchangeExec$ implements scala.Serializable {
  ...
  public  org.apache.spark.sql.execution.exchange.ShuffleExchangeExec apply (org.apache.spark.sql.catalyst.plans.physical.Partitioning newPartitioning, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
  /**
   ...
   */
  private  boolean needToCopyObjectsBeforeShuffle (org.apache.spark.Partitioner partitioner)  { throw new RuntimeException(); }
  /**
