...
public  class FileSourceStrategy$ extends org.apache.spark.sql.execution.SparkStrategy implements org.apache.spark.internal.Logging {
  ...
  private  boolean shouldPruneBuckets (scala.Option<org.apache.spark.sql.catalyst.catalog.BucketSpec> bucketSpec)  { throw new RuntimeException(); }
  private  org.apache.spark.util.collection.BitSet getExpressionBuckets (org.apache.spark.sql.catalyst.expressions.Expression expr, java.lang.String bucketColumnName, int numBuckets)  { throw new RuntimeException(); }
  private  scala.Option<org.apache.spark.util.collection.BitSet> genBucketSet (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> normalizedFilters, org.apache.spark.sql.catalyst.catalog.BucketSpec bucketSpec)  { throw new RuntimeException(); }
