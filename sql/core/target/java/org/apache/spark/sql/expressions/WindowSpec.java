...
public  class WindowSpec {
  ...
  */
  public  org.apache.spark.sql.expressions.WindowSpec rangeBetween (org.apache.spark.sql.Column start, org.apache.spark.sql.Column end)  { throw new RuntimeException(); }
  /**
   * Defines the frame boundaries, from <code>start</code> (inclusive) to <code>end</code> (inclusive).
   * <p>
