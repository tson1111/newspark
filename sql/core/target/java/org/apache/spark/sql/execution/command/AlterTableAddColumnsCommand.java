...
public  class AlterTableAddColumnsCommand extends org.apache.spark.sql.catalyst.plans.logical.LogicalPlan implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.sql.catalyst.catalog.CatalogTable verifyAlterTableAddColumn (org.apache.spark.sql.internal.SQLConf conf, org.apache.spark.sql.catalyst.catalog.SessionCatalog catalog, org.apache.spark.sql.catalyst.TableIdentifier table)  { throw new RuntimeException(); }
}
