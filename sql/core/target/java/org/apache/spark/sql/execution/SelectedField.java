...
public  class SelectedField {
  static public  scala.Option<org.apache.spark.sql.types.StructField> unapply (org.apache.spark.sql.catalyst.expressions.Expression expr)  { throw new RuntimeException(); }
  static private  scala.Option<org.apache.spark.sql.types.StructField> selectField (org.apache.spark.sql.catalyst.expressions.Expression expr, scala.Option<org.apache.spark.sql.types.StructField> fieldOpt)  { throw new RuntimeException(); }
  static private  org.apache.spark.sql.types.DataType wrapStructType (org.apache.spark.sql.types.DataType dataType, org.apache.spark.sql.types.StructField field)  { throw new RuntimeException(); }
}
