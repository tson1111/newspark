...
public  class ContinuousDataSourceRDD extends org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> {
  static   org.apache.spark.sql.sources.v2.reader.streaming.ContinuousInputPartitionReader<?> getContinuousReader (org.apache.spark.sql.sources.v2.reader.InputPartitionReader<org.apache.spark.sql.catalyst.InternalRow> reader)  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.rdd.RDDBarrier<T> barrier ()  { throw new RuntimeException(); }
  ...
  static   boolean isBarrier ()  { throw new RuntimeException(); }
  static protected  boolean isBarrier_ ()  { throw new RuntimeException(); }
  ...
  private  scala.collection.Seq<org.apache.spark.sql.sources.v2.reader.InputPartition<org.apache.spark.sql.catalyst.InternalRow>> readerInputPartitions ()  { throw new RuntimeException(); }
  // not preceding
  public   ContinuousDataSourceRDD (org.apache.spark.SparkContext sc, int dataQueueSize, long epochPollIntervalMs, scala.collection.Seq<org.apache.spark.sql.sources.v2.reader.InputPartition<org.apache.spark.sql.catalyst.InternalRow>> readerInputPartitions)  { throw new RuntimeException(); }
