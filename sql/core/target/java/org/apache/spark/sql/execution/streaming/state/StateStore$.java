...
public  class StateStore$ implements org.apache.spark.internal.Logging {
  ...
  private  scala.collection.mutable.HashMap<org.apache.spark.sql.execution.streaming.state.StateStoreProviderId, org.apache.spark.sql.execution.streaming.state.StateStoreProvider> loadedProviders ()  { throw new RuntimeException(); }
  ...
  private  void reportActiveStoreInstance (org.apache.spark.sql.execution.streaming.state.StateStoreProviderId storeProviderId)  { throw new RuntimeException(); }
  private  boolean verifyIfStoreInstanceActive (org.apache.spark.sql.execution.streaming.state.StateStoreProviderId storeProviderId)  { throw new RuntimeException(); }
