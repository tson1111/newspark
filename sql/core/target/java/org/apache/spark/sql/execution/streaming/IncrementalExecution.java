...
public  class IncrementalExecution extends org.apache.spark.sql.execution.QueryExecution implements org.apache.spark.internal.Logging {
  // not preceding
  public   IncrementalExecution (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan logicalPlan, org.apache.spark.sql.streaming.OutputMode outputMode, java.lang.String checkpointLocation, java.util.UUID runId, long currentBatchId, org.apache.spark.sql.execution.streaming.OffsetSeqMetadata offsetSeqMetadata)  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.execution.streaming.StatefulOperatorStateInfo nextStatefulOperationStateInfo ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  java.util.concurrent.atomic.AtomicInteger statefulOperatorId ()  { throw new RuntimeException(); }
}
