...
/**
 * The physical plan for writing data into a continuous processing {@link StreamWriter}.
 */
public  class WriteToContinuousDataSourceExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.internal.Logging, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   WriteToContinuousDataSourceExec (org.apache.spark.sql.sources.v2.writer.streaming.StreamWriter writer, org.apache.spark.sql.execution.SparkPlan query)  { throw new RuntimeException(); }
