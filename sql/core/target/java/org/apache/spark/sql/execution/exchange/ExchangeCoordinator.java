 ...
 *  - <code>numExchanges</code> is used to indicated that how many {@link ShuffleExchangeExec}s that will be
 *    registered to this coordinator. So, when we start to do any actual work, we have a way to
 *    make sure that we have got expected number of {@link ShuffleExchangeExec}s.
 ...
 *  - Before the execution of a {@link SparkPlan}, for a {@link ShuffleExchangeExec} operator,
 ...
 *  - Once we start to execute a physical plan, a {@link ShuffleExchangeExec} registered to this
 *    coordinator will call <code>postShuffleRDD</code> to get its corresponding post-shuffle
 *    {@link ShuffledRowRDD}.
 *    If this coordinator has made the decision on how to shuffle data, this {@link ShuffleExchangeExec}
 ...
 *    registered {@link ShuffleExchangeExec}s to submit their pre-shuffle stages. Then, based on the
 ...
 *    {@link ShuffleExchangeExec}s. So, when a {@link ShuffleExchangeExec} calls <code>postShuffleRDD</code>, this
 *    coordinator can lookup the corresponding {@link RDD}.
 * <p>
 ...
 * corresponding to the registered {@link ShuffleExchangeExec}s, we will do a pass of those statistics
...
public  class ExchangeCoordinator implements org.apache.spark.internal.Logging {
  ...
  public   ExchangeCoordinator (long advisoryTargetPostShuffleInputSize, scala.Option<java.lang.Object> minNumPostShufflePartitions)  { throw new RuntimeException(); }
  private  int numExchanges ()  { throw new RuntimeException(); }
  private  java.util.Map<org.apache.spark.sql.execution.exchange.ShuffleExchangeExec, org.apache.spark.sql.execution.ShuffledRowRDD> postShuffleRDDs ()  { throw new RuntimeException(); }
  /**
   * Registers a {@link ShuffleExchangeExec} operator to this coordinator. This method is only allowed
   * to be called in the <code>doPrepare</code> method of a {@link ShuffleExchangeExec} operator.
   * @param exchange (undocumented)
   */
  public  void registerExchange (org.apache.spark.sql.execution.exchange.ShuffleExchangeExec exchange)  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.execution.ShuffledRowRDD postShuffleRDD (org.apache.spark.sql.execution.exchange.ShuffleExchangeExec exchange)  { throw new RuntimeException(); }
