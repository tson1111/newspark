...
public  class InMemoryRelation extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.catalyst.analysis.MultiInstanceRelation, scala.Product, scala.Serializable {
  static public  org.apache.spark.sql.execution.columnar.InMemoryRelation apply (boolean useCompression, int batchSize, org.apache.spark.storage.StorageLevel storageLevel, org.apache.spark.sql.execution.SparkPlan child, scala.Option<java.lang.String> tableName, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan logicalPlan)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.execution.columnar.InMemoryRelation apply (org.apache.spark.sql.execution.columnar.CachedRDDBuilder cacheBuilder, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan logicalPlan)  { throw new RuntimeException(); }
  ...
  // not preceding
  public   InMemoryRelation (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.sql.execution.columnar.CachedRDDBuilder cacheBuilder, org.apache.spark.sql.catalyst.plans.logical.Statistics statsOfPlanToCache, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.SortOrder> outputOrdering)  { throw new RuntimeException(); }
