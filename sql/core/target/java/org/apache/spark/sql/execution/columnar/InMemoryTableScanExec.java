...
public  class InMemoryTableScanExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.LeafExecNode, org.apache.spark.sql.execution.ColumnarBatchScan, scala.Product, scala.Serializable {
  private  class ExtractableLiteral$ {
    public   ExtractableLiteral$ ()  { throw new RuntimeException(); }
    public  scala.Option<org.apache.spark.sql.catalyst.expressions.Literal> unapply (org.apache.spark.sql.catalyst.expressions.Expression expr)  { throw new RuntimeException(); }
  }
  ...
  private  int[] columnIndices ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.types.StructField[] relationSchema ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.types.StructType columnarBatchSchema ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.vectorized.ColumnarBatch createAndDecompressColumn (org.apache.spark.sql.execution.columnar.CachedBatch cachedColumnarBatch, boolean offHeapColumnVectorEnabled)  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.execution.columnar.PartitionStatistics stats ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.sql.execution.columnar.InMemoryTableScanExec.ExtractableLiteral$ ExtractableLiteral ()  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.rdd.RDD<org.apache.spark.sql.execution.columnar.CachedBatch> filteredCachedBatches ()  { throw new RuntimeException(); }
