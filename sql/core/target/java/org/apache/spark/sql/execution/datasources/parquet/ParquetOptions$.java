...
public  class ParquetOptions$ implements scala.Serializable {
  ...
  private  scala.collection.immutable.Map<java.lang.String, org.apache.parquet.hadoop.metadata.CompressionCodecName> shortParquetCompressionCodecNames ()  { throw new RuntimeException(); }
