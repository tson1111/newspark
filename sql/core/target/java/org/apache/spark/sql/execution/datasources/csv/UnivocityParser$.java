...
public  class UnivocityParser$ {
  ...
  private <T extends java.lang.Object> java.lang.Object convertStream (java.io.InputStream inputStream, boolean shouldDropHeader, com.univocity.parsers.csv.CsvParser tokenizer, scala.Function1<java.lang.String[], scala.runtime.BoxedUnit> checkHeader, scala.Function1<java.lang.String[], T> convert)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> parseIterator (scala.collection.Iterator<java.lang.String> lines, org.apache.spark.sql.execution.datasources.csv.UnivocityParser parser, org.apache.spark.sql.types.StructType schema)  { throw new RuntimeException(); }
}
