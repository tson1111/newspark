...
public  class WindowExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, scala.Product, scala.Serializable {
   ...
   */
  private  org.apache.spark.sql.execution.window.BoundOrdering createBoundOrdering (org.apache.spark.sql.catalyst.expressions.FrameType frame, org.apache.spark.sql.catalyst.expressions.Expression bound, java.lang.String timeZone)  { throw new RuntimeException(); }
  /**
   * Collection containing an entry for each window frame to process. Each entry contains a frame's
   * {@link WindowExpression}s and factory function for the WindowFrameFunction.
   * @return (undocumented)
   */
