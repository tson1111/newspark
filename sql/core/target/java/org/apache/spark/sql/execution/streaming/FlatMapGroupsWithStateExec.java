...
public  class FlatMapGroupsWithStateExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, org.apache.spark.sql.execution.ObjectProducerExec, org.apache.spark.sql.execution.streaming.StateStoreWriter, org.apache.spark.sql.execution.streaming.WatermarkSupport, scala.Product, scala.Serializable {
  ...
  public  class InputProcessor {
     ...
     * @return (undocumented)
     */
    private  scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> callFunctionAndUpdateState (org.apache.spark.sql.execution.streaming.state.FlatMapGroupsWithStateExecHelper.StateData stateData, scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> valueRowIter, boolean hasTimedOut)  { throw new RuntimeException(); }
  ...
  static protected  void removeKeysOlderThanWatermark (org.apache.spark.sql.execution.streaming.state.StateStore store)  { throw new RuntimeException(); }
  static protected  void removeKeysOlderThanWatermark (org.apache.spark.sql.execution.streaming.state.StreamingAggregationStateManager storeManager, org.apache.spark.sql.execution.streaming.state.StateStore store)  { throw new RuntimeException(); }
  ...
  private  boolean watermarkPresent ()  { throw new RuntimeException(); }
