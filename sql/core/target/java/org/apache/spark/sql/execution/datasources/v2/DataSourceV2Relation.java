 ...
 * <p>
 * param:  source An instance of a {@link DataSourceV2} implementation.
 * param:  options The options for this scan. Used to create fresh {@link DataSourceReader}.
 * param:  userSpecifiedSchema The user-specified schema for this scan. Used to create fresh
 *                            {@link DataSourceReader}.
 */
public  class DataSourceV2Relation extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.catalyst.analysis.MultiInstanceRelation, org.apache.spark.sql.catalyst.analysis.NamedRelation, org.apache.spark.sql.execution.datasources.v2.DataSourceV2StringFormat, scala.Product, scala.Serializable {
  static private  class SourceHelpers {
    public   SourceHelpers (org.apache.spark.sql.sources.v2.DataSourceV2 source)  { throw new RuntimeException(); }
    public  org.apache.spark.sql.sources.v2.ReadSupport asReadSupport ()  { throw new RuntimeException(); }
    public  org.apache.spark.sql.sources.v2.WriteSupport asWriteSupport ()  { throw new RuntimeException(); }
    public  org.apache.spark.sql.sources.v2.reader.DataSourceReader createReader (scala.collection.immutable.Map<java.lang.String, java.lang.String> options, scala.Option<org.apache.spark.sql.types.StructType> userSpecifiedSchema)  { throw new RuntimeException(); }
    public  org.apache.spark.sql.sources.v2.writer.DataSourceWriter createWriter (scala.collection.immutable.Map<java.lang.String, java.lang.String> options, org.apache.spark.sql.types.StructType schema)  { throw new RuntimeException(); }
    public  java.lang.String name ()  { throw new RuntimeException(); }
  }
  static public  org.apache.spark.sql.execution.datasources.v2.DataSourceV2Relation create (org.apache.spark.sql.sources.v2.DataSourceV2 source, scala.collection.immutable.Map<java.lang.String, java.lang.String> options, scala.Option<org.apache.spark.sql.catalyst.TableIdentifier> tableIdent, scala.Option<org.apache.spark.sql.types.StructType> userSpecifiedSchema)  { throw new RuntimeException(); }
  static private  scala.Option<org.apache.spark.sql.catalyst.TableIdentifier> tableFromOptions (scala.collection.immutable.Map<java.lang.String, java.lang.String> options)  { throw new RuntimeException(); }
  ...
  static public  java.lang.String metadataString ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.sources.v2.DataSourceV2 source ()  { throw new RuntimeException(); }
  ...
  public  scala.Option<org.apache.spark.sql.catalyst.TableIdentifier> tableIdent ()  { throw new RuntimeException(); }
  public  scala.Option<org.apache.spark.sql.types.StructType> userSpecifiedSchema ()  { throw new RuntimeException(); }
  // not preceding
  public   DataSourceV2Relation (org.apache.spark.sql.sources.v2.DataSourceV2 source, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.AttributeReference> output, scala.collection.immutable.Map<java.lang.String, java.lang.String> options, scala.Option<org.apache.spark.sql.catalyst.TableIdentifier> tableIdent, scala.Option<org.apache.spark.sql.types.StructType> userSpecifiedSchema)  { throw new RuntimeException(); }
  public  java.lang.String name ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> pushedFilters ()  { throw new RuntimeException(); }
  public  java.lang.String simpleString ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.sources.v2.reader.DataSourceReader newReader ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.sources.v2.writer.DataSourceWriter newWriter ()  { throw new RuntimeException(); }
