...
public  class TextFileFormat extends org.apache.spark.sql.execution.datasources.TextBasedFileFormat implements org.apache.spark.sql.sources.DataSourceRegister {
  ...
  private  scala.Function1<org.apache.spark.sql.execution.datasources.PartitionedFile, scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.UnsafeRow>> readToUnsafeMem (org.apache.spark.broadcast.Broadcast<org.apache.spark.util.SerializableConfiguration> conf, org.apache.spark.sql.types.StructType requiredSchema, org.apache.spark.sql.execution.datasources.text.TextOptions textOptions)  { throw new RuntimeException(); }
