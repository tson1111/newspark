 ...
 */
 final class LongToUnsafeRowMap extends org.apache.spark.memory.MemoryConsumer implements java.io.Externalizable, com.esotericsoftware.kryo.KryoSerializable {
   ...
   * @return (undocumented)
   */
  public  double getAverageProbesPerLookup ()  { throw new RuntimeException(); }
  ...
  private  void grow (int inputRowSize)  { throw new RuntimeException(); }
  ...
  private  long numKeyLookups ()  { throw new RuntimeException(); }
  private  long numKeys ()  { throw new RuntimeException(); }
  private  long numProbes ()  { throw new RuntimeException(); }
