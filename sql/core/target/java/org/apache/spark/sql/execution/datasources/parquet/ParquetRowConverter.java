 ...
 */
  ...
  public   ParquetRowConverter (org.apache.spark.sql.execution.datasources.parquet.ParquetToSparkSchemaConverter schemaConverter, org.apache.parquet.schema.GroupType parquetType, org.apache.spark.sql.types.StructType catalystType, scala.Option<java.util.TimeZone> convertTz, org.apache.spark.sql.execution.datasources.parquet.ParentContainerUpdater updater)  { throw new RuntimeException(); }
  private  java.util.TimeZone UTC ()  { throw new RuntimeException(); }
