 ...
 */
  class HiveUDAFFunction extends org.apache.spark.sql.catalyst.expressions.aggregate.TypedImperativeAggregate<org.apache.hadoop.hive.ql.udf.generic.GenericUDAFEvaluator.AggregationBuffer> implements org.apache.spark.sql.hive.HiveInspectors, org.apache.spark.sql.catalyst.expressions.UserDefinedExpression, scala.Product, scala.Serializable {
  private  class HiveEvaluator implements scala.Product, scala.Serializable {
    public  org.apache.hadoop.hive.ql.udf.generic.GenericUDAFEvaluator evaluator ()  { throw new RuntimeException(); }
    public  org.apache.hadoop.hive.serde2.objectinspector.ObjectInspector objectInspector ()  { throw new RuntimeException(); }
    // not preceding
    public   HiveEvaluator (org.apache.hadoop.hive.ql.udf.generic.GenericUDAFEvaluator evaluator, org.apache.hadoop.hive.serde2.objectinspector.ObjectInspector objectInspector)  { throw new RuntimeException(); }
  }
  private  class HiveEvaluator$ extends scala.runtime.AbstractFunction2<org.apache.hadoop.hive.ql.udf.generic.GenericUDAFEvaluator, org.apache.hadoop.hive.serde2.objectinspector.ObjectInspector, org.apache.spark.sql.hive.HiveUDAFFunction.HiveEvaluator> implements scala.Serializable {
    public   HiveEvaluator$ ()  { throw new RuntimeException(); }
  }
  ...
  private  org.apache.spark.sql.hive.HiveUDAFFunction.HiveEvaluator partial1HiveEvaluator ()  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.hive.HiveUDAFFunction.HiveEvaluator finalHiveEvaluator ()  { throw new RuntimeException(); }
