...
public  class InsertIntoHiveTable extends org.apache.spark.sql.catalyst.plans.logical.LogicalPlan implements org.apache.spark.sql.hive.execution.SaveAsHiveFile, scala.Product, scala.Serializable {
  ...
  static public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> outputColumns ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.execution.datasources.BasicWriteJobStatsTracker basicWriteJobStatsTracker (org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
  static public  scala.Option<org.apache.hadoop.fs.Path> createdTempDir ()  { throw new RuntimeException(); }
  static public  void createdTempDir_$eq (scala.Option<org.apache.hadoop.fs.Path> x$1)  { throw new RuntimeException(); }
  static protected  scala.collection.immutable.Set<java.lang.String> saveAsHiveFile (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.execution.SparkPlan plan, org.apache.hadoop.conf.Configuration hadoopConf, org.apache.spark.sql.hive.HiveShim.ShimFileSinkDesc fileSinkConf, java.lang.String outputLocation, scala.collection.immutable.Map<scala.collection.immutable.Map<java.lang.String, java.lang.String>, java.lang.String> customPartitionLocations, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> partitionAttributes)  { throw new RuntimeException(); }
  static protected  org.apache.hadoop.fs.Path getExternalTmpPath (org.apache.spark.sql.SparkSession sparkSession, org.apache.hadoop.conf.Configuration hadoopConf, org.apache.hadoop.fs.Path path)  { throw new RuntimeException(); }
  static protected  void deleteExternalTmpPath (org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
  static protected  scala.collection.immutable.Map<scala.collection.immutable.Map<java.lang.String, java.lang.String>, java.lang.String> saveAsHiveFile$default$6 ()  { throw new RuntimeException(); }
  static protected  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> saveAsHiveFile$default$7 ()  { throw new RuntimeException(); }
  ...
  private  void processInsert (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.catalyst.catalog.ExternalCatalog externalCatalog, org.apache.hadoop.conf.Configuration hadoopConf, org.apache.hadoop.hive.ql.plan.TableDesc tableDesc, org.apache.hadoop.fs.Path tmpLocation, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
}
