...
public  class ArraysOverlap extends org.apache.spark.sql.catalyst.expressions.BinaryExpression implements org.apache.spark.sql.catalyst.expressions.BinaryArrayExpressionWithImplicitCast, scala.Product, scala.Serializable {
  ...
  private  scala.Function2<org.apache.spark.sql.catalyst.util.ArrayData, org.apache.spark.sql.catalyst.util.ArrayData, java.lang.Object> doEvaluation ()  { throw new RuntimeException(); }
   ...
   * @param arr1 (undocumented)
   * @param arr2 (undocumented)
   * @return (undocumented)
   */
  private  Object fastEval (org.apache.spark.sql.catalyst.util.ArrayData arr1, org.apache.spark.sql.catalyst.util.ArrayData arr2)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  Object bruteForceEval (org.apache.spark.sql.catalyst.util.ArrayData arr1, org.apache.spark.sql.catalyst.util.ArrayData arr2)  { throw new RuntimeException(); }
   ...
   * @param smaller (undocumented)
   * @param bigger (undocumented)
   * @return (undocumented)
   */
  private  java.lang.String fastCodegen (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, org.apache.spark.sql.catalyst.expressions.codegen.ExprCode ev, java.lang.String smaller, java.lang.String bigger)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  java.lang.String bruteForceCodegen (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, org.apache.spark.sql.catalyst.expressions.codegen.ExprCode ev, java.lang.String smaller, java.lang.String bigger)  { throw new RuntimeException(); }
