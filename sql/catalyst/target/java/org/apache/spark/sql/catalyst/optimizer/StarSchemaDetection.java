...
public  class StarSchemaDetection {
   ...
   */
  static private  class TableAccessCardinality implements scala.Product, scala.Serializable {
  ...
  static private  class TableAccessCardinality$ extends scala.runtime.AbstractFunction2<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan, scala.Option<scala.math.BigInt>, org.apache.spark.sql.catalyst.optimizer.StarSchemaDetection.TableAccessCardinality> implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final TableAccessCardinality$ MODULE$ = null;
   ...
   * @return (undocumented)
   */
  static private  boolean isUnique (org.apache.spark.sql.catalyst.expressions.Attribute column, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  scala.Option<org.apache.spark.sql.catalyst.expressions.Attribute> findLeafNodeCol (org.apache.spark.sql.catalyst.expressions.Attribute column, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  boolean hasStatistics (org.apache.spark.sql.catalyst.expressions.Attribute column, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> findJoinConditions (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan1, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan2, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> conditions)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  boolean isSelectiveStarJoin (scala.collection.Seq<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> dimTables, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> conditions)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  scala.Option<scala.math.BigInt> getTableAccessCardinality (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan input)  { throw new RuntimeException(); }
  /**
