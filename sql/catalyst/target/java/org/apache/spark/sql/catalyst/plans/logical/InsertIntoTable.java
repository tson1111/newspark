...
public  class InsertIntoTable extends org.apache.spark.sql.catalyst.plans.logical.LogicalPlan implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   InsertIntoTable (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan table, scala.collection.immutable.Map<java.lang.String, scala.Option<java.lang.String>> partition, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query, boolean overwrite, boolean ifPartitionNotExists)  { throw new RuntimeException(); }
