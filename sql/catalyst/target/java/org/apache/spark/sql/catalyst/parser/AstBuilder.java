...
public  class AstBuilder extends org.apache.spark.sql.catalyst.parser.SqlBaseBaseVisitor<java.lang.Object> implements org.apache.spark.internal.Logging {
  ...
  /**
   * Create an alias ({@link SubqueryAlias}) for a {@link LogicalPlan}.
   ...
   * places, e.g., where <code>(a)?+.+</code> = 2, regex are not meaningful.
   * @param ctx (undocumented)
   * @return (undocumented)
   */
  private  boolean canApplyRegex (org.antlr.v4.runtime.ParserRuleContext ctx)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * If aliases specified in a FROM clause, create a subquery alias ({@link SubqueryAlias}) and
   * column aliases for a {@link LogicalPlan}.
   * @param tableAlias (undocumented)
   * @param plan (undocumented)
   * @return (undocumented)
   */
  private  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan mayApplyAliasPlan (org.apache.spark.sql.catalyst.parser.SqlBaseParser.TableAliasContext tableAlias, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.Tuple3<org.apache.spark.sql.catalyst.TableIdentifier, scala.collection.immutable.Map<java.lang.String, scala.Option<java.lang.String>>, java.lang.Object> visitInsertIntoTable (org.apache.spark.sql.catalyst.parser.SqlBaseParser.InsertIntoTableContext ctx)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Tuple3<org.apache.spark.sql.catalyst.TableIdentifier, scala.collection.immutable.Map<java.lang.String, scala.Option<java.lang.String>>, java.lang.Object> visitInsertOverwriteTable (org.apache.spark.sql.catalyst.parser.SqlBaseParser.InsertOverwriteTableContext ctx)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Add {@link UnresolvedHint}s to a logical plan.
   * @param ctx (undocumented)
   * @param query (undocumented)
   * @return (undocumented)
   */
  ...
  /**
   * Add a {@link Pivot} to a logical plan.
   * @param ctx (undocumented)
   * @param query (undocumented)
   * @return (undocumented)
   */
  private  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan withPivot (org.apache.spark.sql.catalyst.parser.SqlBaseParser.PivotClauseContext ctx, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query)  { throw new RuntimeException(); }
  /**
