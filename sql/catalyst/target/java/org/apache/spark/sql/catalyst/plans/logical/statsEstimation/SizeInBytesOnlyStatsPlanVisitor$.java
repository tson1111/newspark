...
public  class SizeInBytesOnlyStatsPlanVisitor$ implements org.apache.spark.sql.catalyst.plans.logical.LogicalPlanVisitor<org.apache.spark.sql.catalyst.plans.logical.Statistics> {
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.sql.catalyst.plans.logical.Statistics visitUnaryNode (org.apache.spark.sql.catalyst.plans.logical.UnaryNode p)  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.catalyst.plans.logical.Statistics visitHint (org.apache.spark.sql.catalyst.plans.logical.ResolvedHint p)  { throw new RuntimeException(); }
