...
public  class CatalogStatistics implements scala.Product, scala.Serializable {
   ...
   * @param cboEnabled (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.plans.logical.Statistics toPlanStats (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> planOutput, boolean cboEnabled)  { throw new RuntimeException(); }
