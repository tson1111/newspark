...
public  class EstimationUtils {
   ...
   * @param value (undocumented)
   * @param bins (undocumented)
   * @return (undocumented)
   */
  static private  int findFirstBinForValue (double value, org.apache.spark.sql.catalyst.plans.logical.HistogramBin[] bins)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  int findLastBinForValue (double value, org.apache.spark.sql.catalyst.plans.logical.HistogramBin[] bins)  { throw new RuntimeException(); }
  /**
   ...
   * @param bin (undocumented)
   * @return (undocumented)
   */
  static private  double binHoldingRangePossibility (double upperBound, double lowerBound, org.apache.spark.sql.catalyst.plans.logical.HistogramBin bin)  { throw new RuntimeException(); }
  /**
