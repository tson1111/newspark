...
public  class SpecifiedWindowFrame extends org.apache.spark.sql.catalyst.expressions.Expression implements org.apache.spark.sql.catalyst.expressions.WindowFrame, scala.Product, scala.Serializable {
  ...
  private  java.lang.String boundarySql (org.apache.spark.sql.catalyst.expressions.Expression expr)  { throw new RuntimeException(); }
  private  boolean isGreaterThan (org.apache.spark.sql.catalyst.expressions.Expression l, org.apache.spark.sql.catalyst.expressions.Expression r)  { throw new RuntimeException(); }
  private  org.apache.spark.sql.catalyst.analysis.TypeCheckResult checkBoundary (org.apache.spark.sql.catalyst.expressions.Expression b, java.lang.String location)  { throw new RuntimeException(); }
  private  boolean isValidFrameBoundary (org.apache.spark.sql.catalyst.expressions.Expression l, org.apache.spark.sql.catalyst.expressions.Expression u)  { throw new RuntimeException(); }
}
