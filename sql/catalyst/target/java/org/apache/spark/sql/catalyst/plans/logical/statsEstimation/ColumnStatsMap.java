...
public  class ColumnStatsMap implements scala.Product, scala.Serializable {
  ...
  private  scala.collection.mutable.Map<org.apache.spark.sql.catalyst.expressions.ExprId, scala.Tuple2<org.apache.spark.sql.catalyst.expressions.Attribute, org.apache.spark.sql.catalyst.plans.logical.ColumnStat>> updatedMap ()  { throw new RuntimeException(); }
