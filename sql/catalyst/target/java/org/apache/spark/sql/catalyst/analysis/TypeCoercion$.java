...
public  class TypeCoercion$ {
   ...
   * @return (undocumented)
   */
  private  scala.Option<org.apache.spark.sql.types.DataType> findCommonTypeForBinaryComparison (org.apache.spark.sql.types.DataType dt1, org.apache.spark.sql.types.DataType dt2, org.apache.spark.sql.internal.SQLConf conf)  { throw new RuntimeException(); }
  private  scala.Option<org.apache.spark.sql.types.DataType> findTypeForComplex (org.apache.spark.sql.types.DataType t1, org.apache.spark.sql.types.DataType t2, scala.Function2<org.apache.spark.sql.types.DataType, org.apache.spark.sql.types.DataType, scala.Option<org.apache.spark.sql.types.DataType>> findTypeFunc)  { throw new RuntimeException(); }
  /**
  ...
  private  org.apache.spark.sql.catalyst.expressions.Expression castIfNotSameType (org.apache.spark.sql.catalyst.expressions.Expression expr, org.apache.spark.sql.types.DataType dt)  { throw new RuntimeException(); }
}
