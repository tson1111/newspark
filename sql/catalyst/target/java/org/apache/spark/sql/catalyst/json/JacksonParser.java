...
public  class JacksonParser implements org.apache.spark.internal.Logging {
  // not preceding
  public   JacksonParser (org.apache.spark.sql.types.DataType schema, org.apache.spark.sql.catalyst.json.JSONOptions options)  { throw new RuntimeException(); }
  /**
  ...
  private  scala.Function1<com.fasterxml.jackson.core.JsonParser, scala.collection.Seq<org.apache.spark.sql.catalyst.InternalRow>> makeArrayRootConverter (org.apache.spark.sql.types.ArrayType at)  { throw new RuntimeException(); }
  /**
  ...
  private  scala.Function1<com.fasterxml.jackson.core.JsonParser, scala.collection.Seq<org.apache.spark.sql.catalyst.InternalRow>> makeMapRootConverter (org.apache.spark.sql.types.MapType mt)  { throw new RuntimeException(); }
  /**
   * Create a converter which converts the JSON documents held by the <code>JsonParser</code>
   ...
   * @return (undocumented)
   */
  private  scala.Function1<com.fasterxml.jackson.core.JsonParser, scala.collection.Seq<org.apache.spark.sql.catalyst.InternalRow>> makeRootConverter (org.apache.spark.sql.types.DataType dt)  { throw new RuntimeException(); }
  private  scala.Function1<com.fasterxml.jackson.core.JsonParser, scala.collection.Seq<org.apache.spark.sql.catalyst.InternalRow>> makeStructRootConverter (org.apache.spark.sql.types.StructType st)  { throw new RuntimeException(); }
