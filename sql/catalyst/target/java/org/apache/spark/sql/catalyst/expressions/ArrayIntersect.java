...
public  class ArrayIntersect extends org.apache.spark.sql.catalyst.expressions.BinaryExpression implements org.apache.spark.sql.catalyst.expressions.ArrayBinaryLike, org.apache.spark.sql.catalyst.expressions.ComplexTypeMergingExpression, scala.Product, scala.Serializable {
  ...
  static protected  org.apache.spark.sql.types.DataType elementType ()  { throw new RuntimeException(); }
  static public  scala.collection.Seq<org.apache.spark.sql.types.AbstractDataType> inputTypes ()  { throw new RuntimeException(); }
  static protected  boolean canUseSpecializedHashSet ()  { throw new RuntimeException(); }
  static protected  scala.math.Ordering<java.lang.Object> ordering ()  { throw new RuntimeException(); }
  static protected  java.lang.String genGetValue (java.lang.String array, java.lang.String i)  { throw new RuntimeException(); }
  static protected  java.lang.String hsPostFix ()  { throw new RuntimeException(); }
  static protected  java.lang.String hsTypeName ()  { throw new RuntimeException(); }
  static protected  java.lang.String hsValueCast ()  { throw new RuntimeException(); }
  static protected  java.lang.String nullValueHolder ()  { throw new RuntimeException(); }
  static protected  java.lang.String withResultArrayNullCheck (java.lang.String body, java.lang.String value, java.lang.String nullElementIndex)  { throw new RuntimeException(); }
  static public  java.lang.String buildResultArray (java.lang.String builder, java.lang.String value, java.lang.String size, java.lang.String nullElementIndex)  { throw new RuntimeException(); }
  static protected  org.apache.spark.sql.types.DataType dt ()  { throw new RuntimeException(); }
  static protected  org.apache.spark.sql.types.DataType et ()  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.analysis.TypeCheckResult checkInputDataTypes ()  { throw new RuntimeException(); }
  static public  scala.collection.Seq<org.apache.spark.sql.types.DataType> inputTypesForMerging ()  { throw new RuntimeException(); }
  static public  void dataTypeCheck ()  { throw new RuntimeException(); }
