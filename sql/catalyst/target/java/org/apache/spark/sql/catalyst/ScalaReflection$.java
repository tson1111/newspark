...
public  class ScalaReflection$ implements org.apache.spark.sql.catalyst.ScalaReflection {
  ...
  /**
   * Given a type <code>T</code> this function constructs <code>ObjectType</code> that holds a class of type
   * <code>Array[T]</code>.
   * <p>
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.sql.types.ObjectType arrayClassFor (org.apache.spark.sql.catalyst.ScalaReflection.universe tpe)  { throw new RuntimeException(); }
  /**
   ...
   * than the exact matching algorithm in <code>Class.getConstructor</code>. The first assignment-compatible
   * matching constructor is returned. Otherwise, it returns <code>None</code>.
   * @param cls (undocumented)
   * @param paramTypes (undocumented)
   * @return (undocumented)
   */
  public  scala.Option<java.lang.reflect.Constructor<?>> findConstructor (java.lang.Class<?> cls, scala.collection.Seq<java.lang.Class<?>> paramTypes)  { throw new RuntimeException(); }
  /**
