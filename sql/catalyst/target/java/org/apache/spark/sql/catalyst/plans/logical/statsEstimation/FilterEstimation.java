...
public  class FilterEstimation implements org.apache.spark.internal.Logging, scala.Product, scala.Serializable {
   ...
   * @param colStat (undocumented)
   * @return (undocumented)
   */
  private  double computeEqualityPossibilityByHistogram (org.apache.spark.sql.catalyst.expressions.Literal literal, org.apache.spark.sql.catalyst.plans.logical.ColumnStat colStat)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  double computeComparisonPossibilityByHistogram (org.apache.spark.sql.catalyst.expressions.BinaryComparison op, org.apache.spark.sql.catalyst.expressions.Literal literal, org.apache.spark.sql.catalyst.plans.logical.ColumnStat colStat)  { throw new RuntimeException(); }
  /**
