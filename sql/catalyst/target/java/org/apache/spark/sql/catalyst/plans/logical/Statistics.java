...
public  class Statistics implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   Statistics (scala.math.BigInt sizeInBytes, scala.Option<scala.math.BigInt> rowCount, org.apache.spark.sql.catalyst.expressions.AttributeMap<org.apache.spark.sql.catalyst.plans.logical.ColumnStat> attributeStats, org.apache.spark.sql.catalyst.plans.logical.HintInfo hints)  { throw new RuntimeException(); }
