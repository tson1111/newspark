...
public  class SchemaOfJson extends org.apache.spark.sql.catalyst.expressions.UnaryExpression implements org.apache.spark.sql.catalyst.expressions.codegen.CodegenFallback, scala.Product, scala.Serializable {
  ...
  private  org.apache.spark.sql.catalyst.json.JSONOptions jsonOptions ()  { throw new RuntimeException(); }
  private  com.fasterxml.jackson.core.JsonFactory jsonFactory ()  { throw new RuntimeException(); }
  private  org.apache.spark.unsafe.types.UTF8String json ()  { throw new RuntimeException(); }
