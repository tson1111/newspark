...
public  class EliminateOuterJoin {
   ...
   * @return (undocumented)
   */
  static private  boolean canFilterOutNull (org.apache.spark.sql.catalyst.expressions.Expression e)  { throw new RuntimeException(); }
  static private  org.apache.spark.sql.catalyst.plans.JoinType buildNewJoinType (org.apache.spark.sql.catalyst.plans.logical.Filter filter, org.apache.spark.sql.catalyst.plans.logical.Join join)  { throw new RuntimeException(); }
