...
public  class DateTimeUtils {
  ...
  static public  java.text.DateFormat getThreadLocalDateFormat (java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  static private  java.util.concurrent.ConcurrentHashMap<java.lang.String, java.util.TimeZone> computedTimeZones ()  { throw new RuntimeException(); }
  static private  java.lang.Object computeTimeZone ()  { throw new RuntimeException(); }
  ...
  static public  java.lang.String dateToString (int days, java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  ...
  static private  int SUNDAY ()  { throw new RuntimeException(); }
  static private  int MONDAY ()  { throw new RuntimeException(); }
  static private  int TUESDAY ()  { throw new RuntimeException(); }
  static private  int WEDNESDAY ()  { throw new RuntimeException(); }
  static private  int THURSDAY ()  { throw new RuntimeException(); }
  static private  int FRIDAY ()  { throw new RuntimeException(); }
  static private  int SATURDAY ()  { throw new RuntimeException(); }
  ...
  static public  long truncTimestamp (long d, int level)  { throw new RuntimeException(); }
  /**
