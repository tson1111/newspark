...
public  class GenerateSafeProjection$ extends org.apache.spark.sql.catalyst.expressions.codegen.CodeGenerator<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression>, org.apache.spark.sql.catalyst.expressions.Projection> {
  ...
  private  org.apache.spark.sql.catalyst.expressions.codegen.ExprCode convertToSafe (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, org.apache.spark.sql.catalyst.expressions.codegen.ExprValue input, org.apache.spark.sql.types.DataType dataType)  { throw new RuntimeException(); }
