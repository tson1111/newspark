...
public  class JoinReorderDP {
  ...
  static private  scala.collection.immutable.Map<scala.collection.immutable.Set<java.lang.Object>, org.apache.spark.sql.catalyst.optimizer.JoinReorderDP.JoinPlan> searchLevel (scala.collection.Seq<scala.collection.immutable.Map<scala.collection.immutable.Set<java.lang.Object>, org.apache.spark.sql.catalyst.optimizer.JoinReorderDP.JoinPlan>> existingLevels, org.apache.spark.sql.internal.SQLConf conf, scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> conditions, org.apache.spark.sql.catalyst.expressions.AttributeSet topOutput, scala.Option<org.apache.spark.sql.catalyst.optimizer.JoinGraphInfo> filters)  { throw new RuntimeException(); }
  /**
   ...
   */
  static private  scala.Option<org.apache.spark.sql.catalyst.optimizer.JoinReorderDP.JoinPlan> buildJoin (org.apache.spark.sql.catalyst.optimizer.JoinReorderDP.JoinPlan oneJoinPlan, org.apache.spark.sql.catalyst.optimizer.JoinReorderDP.JoinPlan otherJoinPlan, org.apache.spark.sql.internal.SQLConf conf, scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> conditions, org.apache.spark.sql.catalyst.expressions.AttributeSet topOutput, scala.Option<org.apache.spark.sql.catalyst.optimizer.JoinGraphInfo> filters)  { throw new RuntimeException(); }
