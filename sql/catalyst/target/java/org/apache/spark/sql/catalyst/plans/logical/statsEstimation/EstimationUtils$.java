...
public  class EstimationUtils$ {
   ...
   * @return (undocumented)
   */
  private  int findFirstBinForValue (double value, org.apache.spark.sql.catalyst.plans.logical.HistogramBin[] bins)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  int findLastBinForValue (double value, org.apache.spark.sql.catalyst.plans.logical.HistogramBin[] bins)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  double binHoldingRangePossibility (double upperBound, double lowerBound, org.apache.spark.sql.catalyst.plans.logical.HistogramBin bin)  { throw new RuntimeException(); }
  /**
