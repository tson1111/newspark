...
public  class SessionCatalog implements org.apache.spark.internal.Logging {
  ...
  private  scala.util.matching.Regex validNameFormat ()  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Constructs a {@link FunctionBuilder} based on the provided class that represents a function.
   * @param name (undocumented)
   * @param functionClassName (undocumented)
   * @return (undocumented)
   */
  private  scala.Function1<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression>, org.apache.spark.sql.catalyst.expressions.Expression> makeFunctionBuilder (java.lang.String name, java.lang.String functionClassName)  { throw new RuntimeException(); }
  /**
  ...
  protected  scala.runtime.Nothing$ failFunctionLookup (org.apache.spark.sql.catalyst.FunctionIdentifier name)  { throw new RuntimeException(); }
  /**
   ...
   * @param newName (undocumented)
   */
  private  void validateNewLocationOfRename (org.apache.spark.sql.catalyst.TableIdentifier oldName, org.apache.spark.sql.catalyst.TableIdentifier newName)  { throw new RuntimeException(); }
}
